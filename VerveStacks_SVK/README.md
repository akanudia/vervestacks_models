# VerveStacks Model Generation Notes - SVK

**Generated:** 2025-07-31 23:34:32
...
- **Individual Plant Coverage**: 98.1% of total capacity from plant-level GEM data
- **Total Capacity Tracked**: 9.1 GW from all sources
- **Plants Above Threshold**: 28 individual plants tracked above 50 MW threshold
...
### Files Included
- **Source Data**: `source_data/VerveStacks_SVK.xlsx` - Raw data reconciliation between sources
...
- 28 plants tracked individually above threshold
