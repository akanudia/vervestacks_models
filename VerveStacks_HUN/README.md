# VerveStacks Model Generation Notes - HUN

**Generated:** 2025-07-31 23:37:16
...
- **Individual Plant Coverage**: 97.0% of total capacity from plant-level GEM data
- **Total Capacity Tracked**: 15.0 GW from all sources
- **Plants Above Threshold**: 60 individual plants tracked above 50 MW threshold
- **Total Plants Processed**: 74 plants in database
...
### Files Included
- **Source Data**: `source_data/VerveStacks_HUN.xlsx` - Raw data reconciliation between sources
...
- 60 plants tracked individually above threshold
