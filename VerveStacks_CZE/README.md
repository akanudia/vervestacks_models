# VerveStacks Model Generation Notes - CZE

**Generated:** 2025-07-31 23:35:46
...
- **Individual Plant Coverage**: 96.0% of total capacity from plant-level GEM data
- **Total Capacity Tracked**: 19.7 GW from all sources
- **Plants Above Threshold**: 84 individual plants tracked above 50 MW threshold
- **Total Plants Processed**: 110 plants in database
...
### Files Included
- **Source Data**: `source_data/VerveStacks_CZE.xlsx` - Raw data reconciliation between sources
