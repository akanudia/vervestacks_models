...
- **Individual Plant Coverage**: 98.7% of total capacity from plant-level GEM data
- **Total Capacity Tracked**: 30.2 GW from all sources
- **Plants Above Threshold**: 113 individual plants tracked above 50 MW threshold
...
### Files Included
- **Source Data**: `source_data/VerveStacks_AUT.xlsx` - Raw data reconciliation between sources
...
- 113 plants tracked individually above threshold
