...
- Week W01: 04-30 to 05-06 (7 days)
- Week W02: 09-17 to 09-23 (7 days)

#### 📊 **Generated Analysis Files:**
- `segment_summary_SAU.csv` - Statistical summary of all identified critical periods
- `timeslices_SAU_triple_1.csv` - Triple-1 critical periods (3 days: 1 scarcity + 1 surplus + 1 volatile)
- `timeslices_SAU_triple_5.csv` - Triple-5 critical periods (15 days: 5 scarcity + 5 surplus + 5 volatile)
- `timeslices_SAU_weekly_stress.csv` - Weekly stress periods (2 worst weeks for sustained stress)
...
<a href="VerveStacks_SAU/source_data/plan2_triple5_critical_days_SAU.png" target="_blank">
  <img src="VerveStacks_SAU/source_data/plan2_triple5_critical_days_SAU.png" alt="plan2_triple5_critical_days_SAU.png" width="600" style="border: 2px solid #ddd; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); margin: 10px 0; cursor: pointer;" />
</a>

*Click image to view full size*

#### **Weekly Stress Analysis** - Sustained stress periods showing 2 worst weeks for renewable coverage
<a href="VerveStacks_SAU/source_data/plan3_weekly_stress_SAU.png" target="_blank">
  <img src="VerveStacks_SAU/source_data/plan3_weekly_stress_SAU.png" alt="plan3_weekly_stress_SAU.png" width="600" style="border: 2px solid #ddd; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); margin: 10px 0; cursor: pointer;" />
</a>
