...
### Files Included
- **Source Data**: `source_data/VerveStacks_GRC.xlsx` - the full dataset in a model-agnostic format, ready for TIMES/VEDA execution
...
**Analysis Status:** Timeslice analysis completed for GRC


#### 🔥 **Detailed Stress Analysis Results:**

**🌨️ Weekly Sustained Stress Analysis:**
- Week S01: 03-07 to 03-07 (1 days)

#### 📊 **Generated Analysis Files:**
- `segment_summary_GRC.csv` - Statistical summary of all identified critical periods
- `tsdesign_GRC.csv` - Complete VEDA timeslice structure with temporal mappings
...
<a href="VerveStacks_GRC/source_data/aggregation_justification_GRC_s1_d.png" target="_blank">
  <img src="VerveStacks_GRC/source_data/aggregation_justification_GRC_s1_d.png" alt="aggregation_justification_GRC_s1_d.png" width="600" style="border: 2px solid #ddd; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); margin: 10px 0; cursor: pointer;" />
</a>

*Click image to view full size*

#### **Timeslice Aggregation Justification** - Statistical analysis supporting the selected temporal resolution structure
<a href="VerveStacks_GRC/source_data/aggregation_justification_GRC_s1p1v1_d.png" target="_blank">
  <img src="VerveStacks_GRC/source_data/aggregation_justification_GRC_s1p1v1_d.png" alt="aggregation_justification_GRC_s1p1v1_d.png" width="600" style="border: 2px solid #ddd; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); margin: 10px 0; cursor: pointer;" />
</a>

*Click image to view full size*

#### **Timeslice Aggregation Justification** - Statistical analysis supporting the selected temporal resolution structure
<a href="VerveStacks_GRC/source_data/aggregation_justification_GRC_s2_w.png" target="_blank">
  <img src="VerveStacks_GRC/source_data/aggregation_justification_GRC_s2_w.png" alt="aggregation_justification_GRC_s2_w.png" width="600" style="border: 2px solid #ddd; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); margin: 10px 0; cursor: pointer;" />
</a>

*Click image to view full size*

#### **Timeslice Aggregation Justification** - Statistical analysis supporting the selected temporal resolution structure
<a href="VerveStacks_GRC/source_data/aggregation_justification_GRC_s2_w_p2_d.png" target="_blank">
  <img src="VerveStacks_GRC/source_data/aggregation_justification_GRC_s2_w_p2_d.png" alt="aggregation_justification_GRC_s2_w_p2_d.png" width="600" style="border: 2px solid #ddd; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); margin: 10px 0; cursor: pointer;" />
</a>

*Click image to view full size*

#### **Timeslice Aggregation Justification** - Statistical analysis supporting the selected temporal resolution structure
<a href="VerveStacks_GRC/source_data/aggregation_justification_GRC_s3p3v3_d.png" target="_blank">
  <img src="VerveStacks_GRC/source_data/aggregation_justification_GRC_s3p3v3_d.png" alt="aggregation_justification_GRC_s3p3v3_d.png" width="600" style="border: 2px solid #ddd; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); margin: 10px 0; cursor: pointer;" />
</a>

*Click image to view full size*

#### **Timeslice Aggregation Justification** - Statistical analysis supporting the selected temporal resolution structure
<a href="VerveStacks_GRC/source_data/aggregation_justification_GRC_s5p5v5_d.png" target="_blank">
  <img src="VerveStacks_GRC/source_data/aggregation_justification_GRC_s5p5v5_d.png" alt="aggregation_justification_GRC_s5p5v5_d.png" width="600" style="border: 2px solid #ddd; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); margin: 10px 0; cursor: pointer;" />
</a>

*Click image to view full size*

#### **Timeslice Aggregation Justification** - Statistical analysis supporting the selected temporal resolution structure
<a href="VerveStacks_GRC/source_data/aggregation_justification_GRC_ts12_clu.png" target="_blank">
  <img src="VerveStacks_GRC/source_data/aggregation_justification_GRC_ts12_clu.png" alt="aggregation_justification_GRC_ts12_clu.png" width="600" style="border: 2px solid #ddd; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); margin: 10px 0; cursor: pointer;" />
</a>

*Click image to view full size*

#### **Timeslice Aggregation Justification** - Statistical analysis supporting the selected temporal resolution structure
<a href="VerveStacks_GRC/source_data/aggregation_justification_GRC_ts24_clu.png" target="_blank">
  <img src="VerveStacks_GRC/source_data/aggregation_justification_GRC_ts24_clu.png" alt="aggregation_justification_GRC_ts24_clu.png" width="600" style="border: 2px solid #ddd; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); margin: 10px 0; cursor: pointer;" />
</a>

*Click image to view full size*

#### **Timeslice Aggregation Justification** - Statistical analysis supporting the selected temporal resolution structure
<a href="VerveStacks_GRC/source_data/aggregation_justification_GRC_ts48_clu.png" target="_blank">
  <img src="VerveStacks_GRC/source_data/aggregation_justification_GRC_ts48_clu.png" alt="aggregation_justification_GRC_ts48_clu.png" width="600" style="border: 2px solid #ddd; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); margin: 10px 0; cursor: pointer;" />
</a>

*Click image to view full size*

#### **Calendar Year Grc** - Timeslice analysis visualization
<a href="VerveStacks_GRC/source_data/calendar_year_GRC.png" target="_blank">
  <img src="VerveStacks_GRC/source_data/calendar_year_GRC.png" alt="calendar_year_GRC.png" width="600" style="border: 2px solid #ddd; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); margin: 10px 0; cursor: pointer;" />
</a>

*Click image to view full size*

#### **Re Analysis Summary Grc** - Timeslice analysis visualization
<a href="VerveStacks_GRC/source_data/re_analysis_summary_GRC.png" target="_blank">
  <img src="VerveStacks_GRC/source_data/re_analysis_summary_GRC.png" alt="re_analysis_summary_GRC.png" width="600" style="border: 2px solid #ddd; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); margin: 10px 0; cursor: pointer;" />
</a>

*Click image to view full size*

#### **Stress Periods S1 D Grc** - Timeslice analysis visualization
<a href="VerveStacks_GRC/source_data/stress_periods_s1_d_GRC.png" target="_blank">
  <img src="VerveStacks_GRC/source_data/stress_periods_s1_d_GRC.png" alt="stress_periods_s1_d_GRC.png" width="600" style="border: 2px solid #ddd; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); margin: 10px 0; cursor: pointer;" />
</a>

*Click image to view full size*

#### **Stress Periods S2 W Grc** - Timeslice analysis visualization
<a href="VerveStacks_GRC/source_data/stress_periods_s2_w_GRC.png" target="_blank">
  <img src="VerveStacks_GRC/source_data/stress_periods_s2_w_GRC.png" alt="stress_periods_s2_w_GRC.png" width="600" style="border: 2px solid #ddd; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); margin: 10px 0; cursor: pointer;" />
</a>

*Click image to view full size*

#### **Stress Periods S5P5V5 D Grc** - Timeslice analysis visualization
<a href="VerveStacks_GRC/source_data/stress_periods_s5p5v5_d_GRC.png" target="_blank">
  <img src="VerveStacks_GRC/source_data/stress_periods_s5p5v5_d_GRC.png" alt="stress_periods_s5p5v5_d_GRC.png" width="600" style="border: 2px solid #ddd; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); margin: 10px 0; cursor: pointer;" />
</a>

*Click image to view full size*

#### **Renewable Supply Curves** - Cost-ordered renewable resource potential showing solar and wind capacity vs. LCOE
<a href="VerveStacks_GRC/source_data/supply_curves_GRC.png" target="_blank">
  <img src="VerveStacks_GRC/source_data/supply_curves_GRC.png" alt="supply_curves_GRC.png" width="600" style="border: 2px solid #ddd; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); margin: 10px 0; cursor: pointer;" />
</a>
