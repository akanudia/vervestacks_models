...
<a href="VerveStacks_ITA_grids/source_data/aggregation_justification_ITA_s1p1v1_d.png" target="_blank">
  <img src="VerveStacks_ITA_grids/source_data/aggregation_justification_ITA_s1p1v1_d.png" alt="aggregation_justification_ITA_s1p1v1_d.png" width="600" style="border: 2px solid #ddd; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); margin: 10px 0; cursor: pointer;" />
</a>

*Click image to view full size*

#### **Timeslice Aggregation Justification** - Statistical analysis supporting the selected temporal resolution structure
<a href="VerveStacks_ITA_grids/source_data/aggregation_justification_ITA_s2_w.png" target="_blank">
  <img src="VerveStacks_ITA_grids/source_data/aggregation_justification_ITA_s2_w.png" alt="aggregation_justification_ITA_s2_w.png" width="600" style="border: 2px solid #ddd; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); margin: 10px 0; cursor: pointer;" />
</a>

*Click image to view full size*

#### **Timeslice Aggregation Justification** - Statistical analysis supporting the selected temporal resolution structure
<a href="VerveStacks_ITA_grids/source_data/aggregation_justification_ITA_s2_w_p2_d.png" target="_blank">
  <img src="VerveStacks_ITA_grids/source_data/aggregation_justification_ITA_s2_w_p2_d.png" alt="aggregation_justification_ITA_s2_w_p2_d.png" width="600" style="border: 2px solid #ddd; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); margin: 10px 0; cursor: pointer;" />
</a>

*Click image to view full size*

#### **Timeslice Aggregation Justification** - Statistical analysis supporting the selected temporal resolution structure
<a href="VerveStacks_ITA_grids/source_data/aggregation_justification_ITA_s3p3v3_d.png" target="_blank">
  <img src="VerveStacks_ITA_grids/source_data/aggregation_justification_ITA_s3p3v3_d.png" alt="aggregation_justification_ITA_s3p3v3_d.png" width="600" style="border: 2px solid #ddd; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); margin: 10px 0; cursor: pointer;" />
</a>

*Click image to view full size*

#### **Timeslice Aggregation Justification** - Statistical analysis supporting the selected temporal resolution structure
<a href="VerveStacks_ITA_grids/source_data/aggregation_justification_ITA_s5p5v5_d.png" target="_blank">
  <img src="VerveStacks_ITA_grids/source_data/aggregation_justification_ITA_s5p5v5_d.png" alt="aggregation_justification_ITA_s5p5v5_d.png" width="600" style="border: 2px solid #ddd; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); margin: 10px 0; cursor: pointer;" />
</a>

*Click image to view full size*

#### **Timeslice Aggregation Justification** - Statistical analysis supporting the selected temporal resolution structure
<a href="VerveStacks_ITA_grids/source_data/aggregation_justification_ITA_ts12_clu.png" target="_blank">
  <img src="VerveStacks_ITA_grids/source_data/aggregation_justification_ITA_ts12_clu.png" alt="aggregation_justification_ITA_ts12_clu.png" width="600" style="border: 2px solid #ddd; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); margin: 10px 0; cursor: pointer;" />
</a>

*Click image to view full size*

#### **Timeslice Aggregation Justification** - Statistical analysis supporting the selected temporal resolution structure
<a href="VerveStacks_ITA_grids/source_data/aggregation_justification_ITA_ts24_clu.png" target="_blank">
  <img src="VerveStacks_ITA_grids/source_data/aggregation_justification_ITA_ts24_clu.png" alt="aggregation_justification_ITA_ts24_clu.png" width="600" style="border: 2px solid #ddd; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); margin: 10px 0; cursor: pointer;" />
</a>

*Click image to view full size*

#### **Timeslice Aggregation Justification** - Statistical analysis supporting the selected temporal resolution structure
<a href="VerveStacks_ITA_grids/source_data/aggregation_justification_ITA_ts48_clu.png" target="_blank">
  <img src="VerveStacks_ITA_grids/source_data/aggregation_justification_ITA_ts48_clu.png" alt="aggregation_justification_ITA_ts48_clu.png" width="600" style="border: 2px solid #ddd; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); margin: 10px 0; cursor: pointer;" />
</a>

*Click image to view full size*

#### **Calendar Year Ita** - Timeslice analysis visualization
<a href="VerveStacks_ITA_grids/source_data/calendar_year_ITA.png" target="_blank">
  <img src="VerveStacks_ITA_grids/source_data/calendar_year_ITA.png" alt="calendar_year_ITA.png" width="600" style="border: 2px solid #ddd; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); margin: 10px 0; cursor: pointer;" />
</a>
...
<a href="VerveStacks_ITA_grids/source_data/stress_periods_s2_w_ITA.png" target="_blank">
  <img src="VerveStacks_ITA_grids/source_data/stress_periods_s2_w_ITA.png" alt="stress_periods_s2_w_ITA.png" width="600" style="border: 2px solid #ddd; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); margin: 10px 0; cursor: pointer;" />
</a>

*Click image to view full size*

#### **Stress Periods S2 W P2 D Daily Ita** - Timeslice analysis visualization
<a href="VerveStacks_ITA_grids/source_data/stress_periods_s2_w_p2_d_daily_ITA.png" target="_blank">
  <img src="VerveStacks_ITA_grids/source_data/stress_periods_s2_w_p2_d_daily_ITA.png" alt="stress_periods_s2_w_p2_d_daily_ITA.png" width="600" style="border: 2px solid #ddd; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); margin: 10px 0; cursor: pointer;" />
</a>

*Click image to view full size*

#### **Stress Periods S2 W P2 D Ita** - Timeslice analysis visualization
<a href="VerveStacks_ITA_grids/source_data/stress_periods_s2_w_p2_d_ITA.png" target="_blank">
  <img src="VerveStacks_ITA_grids/source_data/stress_periods_s2_w_p2_d_ITA.png" alt="stress_periods_s2_w_p2_d_ITA.png" width="600" style="border: 2px solid #ddd; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); margin: 10px 0; cursor: pointer;" />
</a>

*Click image to view full size*

#### **Stress Periods S2 W P2 D Weekly Ita** - Timeslice analysis visualization
<a href="VerveStacks_ITA_grids/source_data/stress_periods_s2_w_p2_d_weekly_ITA.png" target="_blank">
  <img src="VerveStacks_ITA_grids/source_data/stress_periods_s2_w_p2_d_weekly_ITA.png" alt="stress_periods_s2_w_p2_d_weekly_ITA.png" width="600" style="border: 2px solid #ddd; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); margin: 10px 0; cursor: pointer;" />
</a>

*Click image to view full size*

#### **Stress Periods S3P3V3 D Ita** - Timeslice analysis visualization
<a href="VerveStacks_ITA_grids/source_data/stress_periods_s3p3v3_d_ITA.png" target="_blank">
  <img src="VerveStacks_ITA_grids/source_data/stress_periods_s3p3v3_d_ITA.png" alt="stress_periods_s3p3v3_d_ITA.png" width="600" style="border: 2px solid #ddd; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); margin: 10px 0; cursor: pointer;" />
</a>

*Click image to view full size*

#### **Stress Periods S5P5V5 D Ita** - Timeslice analysis visualization
<a href="VerveStacks_ITA_grids/source_data/stress_periods_s5p5v5_d_ITA.png" target="_blank">
  <img src="VerveStacks_ITA_grids/source_data/stress_periods_s5p5v5_d_ITA.png" alt="stress_periods_s5p5v5_d_ITA.png" width="600" style="border: 2px solid #ddd; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); margin: 10px 0; cursor: pointer;" />
</a>
