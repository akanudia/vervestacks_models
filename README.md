...
<a href="VerveStacks_CHE/source_data/aggregation_justification_CHE_s1_d.png" target="_blank">
  <img src="VerveStacks_CHE/source_data/aggregation_justification_CHE_s1_d.png" alt="aggregation_justification_CHE_s1_d.png" width="600" style="border: 2px solid #ddd; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); margin: 10px 0; cursor: pointer;" />
</a>

*Click image to view full size*

#### **Timeslice Aggregation Justification** - Statistical analysis supporting the selected temporal resolution structure
<a href="VerveStacks_CHE/source_data/aggregation_justification_CHE_s1p1v1_d.png" target="_blank">
  <img src="VerveStacks_CHE/source_data/aggregation_justification_CHE_s1p1v1_d.png" alt="aggregation_justification_CHE_s1p1v1_d.png" width="600" style="border: 2px solid #ddd; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); margin: 10px 0; cursor: pointer;" />
</a>

*Click image to view full size*

#### **Timeslice Aggregation Justification** - Statistical analysis supporting the selected temporal resolution structure
<a href="VerveStacks_CHE/source_data/aggregation_justification_CHE_s2_w.png" target="_blank">
  <img src="VerveStacks_CHE/source_data/aggregation_justification_CHE_s2_w.png" alt="aggregation_justification_CHE_s2_w.png" width="600" style="border: 2px solid #ddd; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); margin: 10px 0; cursor: pointer;" />
</a>

*Click image to view full size*

#### **Timeslice Aggregation Justification** - Statistical analysis supporting the selected temporal resolution structure
<a href="VerveStacks_CHE/source_data/aggregation_justification_CHE_s2_w_p2_d.png" target="_blank">
  <img src="VerveStacks_CHE/source_data/aggregation_justification_CHE_s2_w_p2_d.png" alt="aggregation_justification_CHE_s2_w_p2_d.png" width="600" style="border: 2px solid #ddd; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); margin: 10px 0; cursor: pointer;" />
</a>

*Click image to view full size*

#### **Timeslice Aggregation Justification** - Statistical analysis supporting the selected temporal resolution structure
<a href="VerveStacks_CHE/source_data/aggregation_justification_CHE_s3p3v3_d.png" target="_blank">
  <img src="VerveStacks_CHE/source_data/aggregation_justification_CHE_s3p3v3_d.png" alt="aggregation_justification_CHE_s3p3v3_d.png" width="600" style="border: 2px solid #ddd; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); margin: 10px 0; cursor: pointer;" />
</a>

*Click image to view full size*

#### **Timeslice Aggregation Justification** - Statistical analysis supporting the selected temporal resolution structure
<a href="VerveStacks_CHE/source_data/aggregation_justification_CHE_s5p5v5_d.png" target="_blank">
  <img src="VerveStacks_CHE/source_data/aggregation_justification_CHE_s5p5v5_d.png" alt="aggregation_justification_CHE_s5p5v5_d.png" width="600" style="border: 2px solid #ddd; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); margin: 10px 0; cursor: pointer;" />
</a>

*Click image to view full size*

#### **Timeslice Aggregation Justification** - Statistical analysis supporting the selected temporal resolution structure
<a href="VerveStacks_CHE/source_data/aggregation_justification_CHE_ts12_clu.png" target="_blank">
  <img src="VerveStacks_CHE/source_data/aggregation_justification_CHE_ts12_clu.png" alt="aggregation_justification_CHE_ts12_clu.png" width="600" style="border: 2px solid #ddd; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); margin: 10px 0; cursor: pointer;" />
</a>

*Click image to view full size*

#### **Timeslice Aggregation Justification** - Statistical analysis supporting the selected temporal resolution structure
<a href="VerveStacks_CHE/source_data/aggregation_justification_CHE_ts24_clu.png" target="_blank">
  <img src="VerveStacks_CHE/source_data/aggregation_justification_CHE_ts24_clu.png" alt="aggregation_justification_CHE_ts24_clu.png" width="600" style="border: 2px solid #ddd; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); margin: 10px 0; cursor: pointer;" />
</a>

*Click image to view full size*

#### **Timeslice Aggregation Justification** - Statistical analysis supporting the selected temporal resolution structure
<a href="VerveStacks_CHE/source_data/aggregation_justification_CHE_ts48_clu.png" target="_blank">
  <img src="VerveStacks_CHE/source_data/aggregation_justification_CHE_ts48_clu.png" alt="aggregation_justification_CHE_ts48_clu.png" width="600" style="border: 2px solid #ddd; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); margin: 10px 0; cursor: pointer;" />
</a>

*Click image to view full size*

#### **Calendar Year Che** - Timeslice analysis visualization
<a href="VerveStacks_CHE/source_data/calendar_year_CHE.png" target="_blank">
  <img src="VerveStacks_CHE/source_data/calendar_year_CHE.png" alt="calendar_year_CHE.png" width="600" style="border: 2px solid #ddd; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); margin: 10px 0; cursor: pointer;" />
</a>

*Click image to view full size*

#### **Re Analysis Summary Che** - Timeslice analysis visualization
<a href="VerveStacks_CHE/source_data/re_analysis_summary_CHE.png" target="_blank">
  <img src="VerveStacks_CHE/source_data/re_analysis_summary_CHE.png" alt="re_analysis_summary_CHE.png" width="600" style="border: 2px solid #ddd; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); margin: 10px 0; cursor: pointer;" />
</a>

*Click image to view full size*

#### **Stress Periods S1 D Che** - Timeslice analysis visualization
<a href="VerveStacks_CHE/source_data/stress_periods_s1_d_CHE.png" target="_blank">
  <img src="VerveStacks_CHE/source_data/stress_periods_s1_d_CHE.png" alt="stress_periods_s1_d_CHE.png" width="600" style="border: 2px solid #ddd; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); margin: 10px 0; cursor: pointer;" />
</a>

*Click image to view full size*

#### **Stress Periods S2 W Che** - Timeslice analysis visualization
<a href="VerveStacks_CHE/source_data/stress_periods_s2_w_CHE.png" target="_blank">
  <img src="VerveStacks_CHE/source_data/stress_periods_s2_w_CHE.png" alt="stress_periods_s2_w_CHE.png" width="600" style="border: 2px solid #ddd; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); margin: 10px 0; cursor: pointer;" />
</a>

*Click image to view full size*

#### **Stress Periods S5P5V5 D Che** - Timeslice analysis visualization
<a href="VerveStacks_CHE/source_data/stress_periods_s5p5v5_d_CHE.png" target="_blank">
  <img src="VerveStacks_CHE/source_data/stress_periods_s5p5v5_d_CHE.png" alt="stress_periods_s5p5v5_d_CHE.png" width="600" style="border: 2px solid #ddd; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); margin: 10px 0; cursor: pointer;" />
</a>
