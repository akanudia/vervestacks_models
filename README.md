...
### Files Included
- **Source Data**: `source_data/VerveStacks_SAU.xlsx` - the full dataset in a model-agnostic format, ready for TIMES/VEDA execution
...
**Analysis Status:** Timeslice analysis completed for SAU


#### 🔥 **Detailed Stress Analysis Results:**

#### 📊 **Generated Analysis Files:**
- `segment_summary_SAU.csv` - Statistical summary of all identified critical periods
- `tsdesign_SAU.csv` - Complete VEDA timeslice structure with temporal mappings
...
<a href="VerveStacks_SAU/source_data/aggregation_justification_SAU.png" target="_blank">
  <img src="VerveStacks_SAU/source_data/aggregation_justification_SAU.png" alt="aggregation_justification_SAU.png" width="600" style="border: 2px solid #ddd; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); margin: 10px 0; cursor: pointer;" />
</a>

*Click image to view full size*

#### **Timeslice Aggregation Justification** - Statistical analysis supporting the selected temporal resolution structure
<a href="VerveStacks_SAU/source_data/aggregation_justification_SAU_s1p1v1_d.png" target="_blank">
  <img src="VerveStacks_SAU/source_data/aggregation_justification_SAU_s1p1v1_d.png" alt="aggregation_justification_SAU_s1p1v1_d.png" width="600" style="border: 2px solid #ddd; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); margin: 10px 0; cursor: pointer;" />
</a>

*Click image to view full size*

#### **Timeslice Aggregation Justification** - Statistical analysis supporting the selected temporal resolution structure
<a href="VerveStacks_SAU/source_data/aggregation_justification_SAU_s2_w.png" target="_blank">
  <img src="VerveStacks_SAU/source_data/aggregation_justification_SAU_s2_w.png" alt="aggregation_justification_SAU_s2_w.png" width="600" style="border: 2px solid #ddd; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); margin: 10px 0; cursor: pointer;" />
</a>

*Click image to view full size*

#### **Timeslice Aggregation Justification** - Statistical analysis supporting the selected temporal resolution structure
<a href="VerveStacks_SAU/source_data/aggregation_justification_SAU_s2_w_p2_d.png" target="_blank">
  <img src="VerveStacks_SAU/source_data/aggregation_justification_SAU_s2_w_p2_d.png" alt="aggregation_justification_SAU_s2_w_p2_d.png" width="600" style="border: 2px solid #ddd; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); margin: 10px 0; cursor: pointer;" />
</a>

*Click image to view full size*

#### **Timeslice Aggregation Justification** - Statistical analysis supporting the selected temporal resolution structure
<a href="VerveStacks_SAU/source_data/aggregation_justification_SAU_s3p3v3_d.png" target="_blank">
  <img src="VerveStacks_SAU/source_data/aggregation_justification_SAU_s3p3v3_d.png" alt="aggregation_justification_SAU_s3p3v3_d.png" width="600" style="border: 2px solid #ddd; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); margin: 10px 0; cursor: pointer;" />
</a>

*Click image to view full size*

#### **Timeslice Aggregation Justification** - Statistical analysis supporting the selected temporal resolution structure
<a href="VerveStacks_SAU/source_data/aggregation_justification_SAU_s5p5v5_d.png" target="_blank">
  <img src="VerveStacks_SAU/source_data/aggregation_justification_SAU_s5p5v5_d.png" alt="aggregation_justification_SAU_s5p5v5_d.png" width="600" style="border: 2px solid #ddd; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); margin: 10px 0; cursor: pointer;" />
</a>

*Click image to view full size*

#### **Timeslice Aggregation Justification** - Statistical analysis supporting the selected temporal resolution structure
<a href="VerveStacks_SAU/source_data/aggregation_justification_SAU_ts12_clu.png" target="_blank">
  <img src="VerveStacks_SAU/source_data/aggregation_justification_SAU_ts12_clu.png" alt="aggregation_justification_SAU_ts12_clu.png" width="600" style="border: 2px solid #ddd; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); margin: 10px 0; cursor: pointer;" />
</a>

*Click image to view full size*

#### **Timeslice Aggregation Justification** - Statistical analysis supporting the selected temporal resolution structure
<a href="VerveStacks_SAU/source_data/aggregation_justification_SAU_ts24_clu.png" target="_blank">
  <img src="VerveStacks_SAU/source_data/aggregation_justification_SAU_ts24_clu.png" alt="aggregation_justification_SAU_ts24_clu.png" width="600" style="border: 2px solid #ddd; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); margin: 10px 0; cursor: pointer;" />
</a>

*Click image to view full size*

#### **Timeslice Aggregation Justification** - Statistical analysis supporting the selected temporal resolution structure
<a href="VerveStacks_SAU/source_data/aggregation_justification_SAU_ts48_clu.png" target="_blank">
  <img src="VerveStacks_SAU/source_data/aggregation_justification_SAU_ts48_clu.png" alt="aggregation_justification_SAU_ts48_clu.png" width="600" style="border: 2px solid #ddd; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); margin: 10px 0; cursor: pointer;" />
</a>

*Click image to view full size*

#### **Calendar Year Sau** - Timeslice analysis visualization
<a href="VerveStacks_SAU/source_data/calendar_year_SAU.png" target="_blank">
  <img src="VerveStacks_SAU/source_data/calendar_year_SAU.png" alt="calendar_year_SAU.png" width="600" style="border: 2px solid #ddd; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); margin: 10px 0; cursor: pointer;" />
</a>

*Click image to view full size*

#### **Re Analysis Summary Sau** - Timeslice analysis visualization
<a href="VerveStacks_SAU/source_data/re_analysis_summary_SAU.png" target="_blank">
  <img src="VerveStacks_SAU/source_data/re_analysis_summary_SAU.png" alt="re_analysis_summary_SAU.png" width="600" style="border: 2px solid #ddd; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); margin: 10px 0; cursor: pointer;" />
</a>

*Click image to view full size*

#### **Stress Periods S2 W P2 D Daily Sau** - Timeslice analysis visualization
<a href="VerveStacks_SAU/source_data/stress_periods_s2_w_p2_d_daily_SAU.png" target="_blank">
  <img src="VerveStacks_SAU/source_data/stress_periods_s2_w_p2_d_daily_SAU.png" alt="stress_periods_s2_w_p2_d_daily_SAU.png" width="600" style="border: 2px solid #ddd; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); margin: 10px 0; cursor: pointer;" />
</a>

*Click image to view full size*

#### **Stress Periods S2 W P2 D Weekly Sau** - Timeslice analysis visualization
<a href="VerveStacks_SAU/source_data/stress_periods_s2_w_p2_d_weekly_SAU.png" target="_blank">
  <img src="VerveStacks_SAU/source_data/stress_periods_s2_w_p2_d_weekly_SAU.png" alt="stress_periods_s2_w_p2_d_weekly_SAU.png" width="600" style="border: 2px solid #ddd; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); margin: 10px 0; cursor: pointer;" />
</a>

*Click image to view full size*

#### **Stress Periods S2 W Sau** - Timeslice analysis visualization
<a href="VerveStacks_SAU/source_data/stress_periods_s2_w_SAU.png" target="_blank">
  <img src="VerveStacks_SAU/source_data/stress_periods_s2_w_SAU.png" alt="stress_periods_s2_w_SAU.png" width="600" style="border: 2px solid #ddd; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); margin: 10px 0; cursor: pointer;" />
</a>

*Click image to view full size*

#### **Stress Periods S3P3V3 D Sau** - Timeslice analysis visualization
<a href="VerveStacks_SAU/source_data/stress_periods_s3p3v3_d_SAU.png" target="_blank">
  <img src="VerveStacks_SAU/source_data/stress_periods_s3p3v3_d_SAU.png" alt="stress_periods_s3p3v3_d_SAU.png" width="600" style="border: 2px solid #ddd; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); margin: 10px 0; cursor: pointer;" />
</a>

*Click image to view full size*

#### **Stress Periods S5P5V5 D Sau** - Timeslice analysis visualization
<a href="VerveStacks_SAU/source_data/stress_periods_s5p5v5_d_SAU.png" target="_blank">
  <img src="VerveStacks_SAU/source_data/stress_periods_s5p5v5_d_SAU.png" alt="stress_periods_s5p5v5_d_SAU.png" width="600" style="border: 2px solid #ddd; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); margin: 10px 0; cursor: pointer;" />
</a>

*Click image to view full size*

#### **Renewable Supply Curves** - Cost-ordered renewable resource potential showing solar and wind capacity vs. LCOE
<a href="VerveStacks_SAU/source_data/supply_curves_SAU.png" target="_blank">
  <img src="VerveStacks_SAU/source_data/supply_curves_SAU.png" alt="supply_curves_SAU.png" width="600" style="border: 2px solid #ddd; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); margin: 10px 0; cursor: pointer;" />
</a>
