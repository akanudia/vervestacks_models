...
- **Total Capacity Tracked**: 244.2 GW from all sources
- **Plants Above Threshold**: 312 individual plants tracked above 100 MW threshold
- **Total Plants Processed**: 447 plants in database
...
### Files Included
- **Source Data**: `source_data/VerveStacks_DEU.xlsx` - Raw data reconciliation between sources
...
- 312 plants tracked individually above threshold
