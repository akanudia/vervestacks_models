...
- **Individual Plant Coverage**: 99.3% of total capacity from plant-level GEM data
- **Total Capacity Tracked**: 110.0 GW from all sources
- **Plants Above Threshold**: 464 individual plants tracked above 50 MW threshold
- **Total Plants Processed**: 490 plants in database
...
### Files Included
- **Source Data**: `source_data/VerveStacks_IDN.xlsx` - the full dataset in a model-agnostic format, ready for TIMES/VEDA execution
...
- 464 plants tracked individually above threshold
