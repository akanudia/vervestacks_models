...
|---------------|---------------|----------------------------|--------------------|--------------------------|-----------------|
| 🌱 **Bioenergy** | 50 MW | 1/1 plants | 0.13 GW | — | 27% |
| ⚫ **Coal** | 10 MW | 6/6 plants | 2.88 GW | — | 30% |
| 🔥 **Gas** | 10 MW | 18/18 plants | 8.85 GW | — | 45% |
| 💧 **Hydro** | 10 MW | 16/16 plants | 3.58 GW | — | 100% |
| 🛢️ **Oil** | 10 MW | 28/28 plants | 1.44 GW | — | 26% |
...
|---------------|----------------------------|-------------------------------|
| ⚫ **Coal** | 2.88 GW | 1.78 GW after capacity penalty |
| 🔥 **Gas** | 8.85 GW | 7.48 GW after capacity penalty |
...
<div align="center">
<img src="VerveStacks_GRC/renewable_energy/supply_curves_GRC.svg" alt="Renewable Energy Supply Curves" width="100%">
</div>
...
| **P10 (Dry Scenario)** | 11.2% annual average | Security planning, reserve sizing |
| **P50 (Base Scenario)** | 12.1% annual average | Expected case, financial planning |
| **P90 (Wet Scenario)** | 12.9% annual average | Export opportunities, minimum backup |
| **Historical Average** | 15.9% (2000-2023) | Validation benchmark |
| **Drought Threshold** | 12.5% (P20 of historical) | Operational stress indicator |

### **Monthly Availability Patterns**

<div align="center">
  <img src="VerveStacks_GRC/source_data/GRC_hydro_monthly_profile.png" 
...
<div align="center">
  <img src="VerveStacks_GRC/source_data/GRC_hydro_annual_trajectory.png" 
...
<div align="center">
<img src="VerveStacks_GRC/timeslice_analysis/re_analysis_summary_GRC.svg" alt="Renewable Energy Analysis Summary" width="100%">
</div>

#### **Aggregated months and hours (8 X 8 case)**
<div align="center">
<img src="VerveStacks_GRC/timeslice_analysis/aggregation_justification_GRC_ts_064.svg" alt="Aggregated slices clustering" width="100%">
</div>

#### **Weekly Stress Periods (Extended Analysis)**
<div align="center">
<img src="VerveStacks_GRC/timeslice_analysis/stress_periods_s2_w_GRC.svg" alt="Weekly Stress Periods" width="100%">
</div>

#### **Triple-5 Critical Periods (Comprehensive Stress Analysis)**
<div align="center">
<img src="VerveStacks_GRC/timeslice_analysis/stress_periods_s5p5v5_d_GRC.svg" alt="Triple-5 Critical Periods" width="100%">
</div>
...
<div align="center">
  <img src="VerveStacks_GRC/scenario_drivers/ar6_scenarios_GRC.png" 
