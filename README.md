# VerveStacks Model Generation Notes - AUT
**Generated:** 2025-09-13 16:37:40
...
|---------------|---------------|----------------------------|--------------------|--------------------------|-----------------|
| 🌱 **Bioenergy** | 50 MW | 2/2 plants | 1.2 GW | — | 36% |
| 🔥 **Gas** | 10 MW | 22/22 plants | 4.79 GW | 0.398 GW | 52% |
| 💧 **Hydro** | 10 MW | 67/67 plants | 15.8 GW | — | 100% |
| 🛢️ **Oil** | 10 MW | 2/2 plants | 0.23 GW | — | 32% |
| ☀️ **Solar** | 200 MW | 1/6 plants | 3.9 GW | — | 100% |
| 💨 **Windon** | 200 MW | 8/22 plants | 3.93 GW | — | 33% |
...
| 🔥 **Gas** | 5.19 GW | 4.38 GW after capacity penalty |
...
- **Total Capacity Tracked**: 30.2 GW GW from all sources
- **Plants Above Threshold**: 78 individual plants tracked
- **Total Plants Processed**: 121 plants in database
...
### Files Included
- **Source Data**: `source_data/VerveStacks_AUT.xlsx` - the full dataset in a model-agnostic format
...
<div align="center">
<img src="VerveStacks_AUT/renewable_energy/supply_curves_AUT.svg" alt="Renewable Energy Supply Curves" width="100%">
</div>
...
### **Austria Hydro Profile**

| **Planning Parameter** | **Value** | **Application** |
|----------------------|-----------|-----------------|
| **Hydro Dependency** | 55% of generation | System vulnerability assessment |
| **P10 (Dry Scenario)** | 28.7% annual average | Security planning, reserve sizing |
| **P50 (Base Scenario)** | 30.5% annual average | Expected case, financial planning |
| **P90 (Wet Scenario)** | 32.5% annual average | Export opportunities, minimum backup |
| **Historical Average** | 34.0% (2000-2023) | Validation benchmark |
| **Drought Threshold** | 30.9% (P20 of historical) | Operational stress indicator |

### **Monthly Availability Patterns**

<div align="center">
  <img src="VerveStacks_AUT/source_data/AUT_hydro_monthly_profile.png" 
...
<div align="center">
  <img src="VerveStacks_AUT/source_data/AUT_hydro_annual_trajectory.png" 
...
<div align="center">
<img src="VerveStacks_AUT/timeslice_analysis/re_analysis_summary_AUT.svg" alt="Renewable Energy Analysis Summary" width="100%">
</div>

#### **Aggregated months and hours (8 X 8 case)**
<div align="center">
<img src="VerveStacks_AUT/timeslice_analysis/aggregation_justification_AUT_ts_064.svg" alt="Aggregated slices clustering" width="100%">
</div>

#### **Weekly Stress Periods (Extended Analysis)**
<div align="center">
<img src="VerveStacks_AUT/timeslice_analysis/stress_periods_s2_w_AUT.svg" alt="Weekly Stress Periods" width="100%">
</div>

#### **Triple-5 Critical Periods (Comprehensive Stress Analysis)**
<div align="center">
<img src="VerveStacks_AUT/timeslice_analysis/stress_periods_s5p5v5_d_AUT.svg" alt="Triple-5 Critical Periods" width="100%">
</div>
...
<div align="center">
  <img src="VerveStacks_AUT/scenario_drivers/ar6_scenarios_AUT.png" 
...
- Charts and analysis files are located in `2_ts_design/outputs/AUT/`
