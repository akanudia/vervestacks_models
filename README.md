...
### Files Included
- **Source Data**: `source_data/VerveStacks_BRA.xlsx` - the full dataset in a model-agnostic format, ready for TIMES/VEDA execution
...
**Analysis Status:** Timeslice analysis completed for BRA


#### 🔥 **Detailed Stress Analysis Results:**

**🌨️ Weekly Sustained Stress Analysis:**
- Week S01: 11-28 to 11-28 (1 days)

#### 📊 **Generated Analysis Files:**
- `segment_summary_BRA.csv` - Statistical summary of all identified critical periods
- `tsdesign_BRA.csv` - Complete VEDA timeslice structure with temporal mappings
...
<a href="VerveStacks_BRA/source_data/aggregation_justification_BRA_s1_d.png" target="_blank">
  <img src="VerveStacks_BRA/source_data/aggregation_justification_BRA_s1_d.png" alt="aggregation_justification_BRA_s1_d.png" width="600" style="border: 2px solid #ddd; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); margin: 10px 0; cursor: pointer;" />
</a>

*Click image to view full size*

#### **Timeslice Aggregation Justification** - Statistical analysis supporting the selected temporal resolution structure
<a href="VerveStacks_BRA/source_data/aggregation_justification_BRA_s1p1v1_d.png" target="_blank">
  <img src="VerveStacks_BRA/source_data/aggregation_justification_BRA_s1p1v1_d.png" alt="aggregation_justification_BRA_s1p1v1_d.png" width="600" style="border: 2px solid #ddd; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); margin: 10px 0; cursor: pointer;" />
</a>

*Click image to view full size*

#### **Timeslice Aggregation Justification** - Statistical analysis supporting the selected temporal resolution structure
<a href="VerveStacks_BRA/source_data/aggregation_justification_BRA_s2_w.png" target="_blank">
  <img src="VerveStacks_BRA/source_data/aggregation_justification_BRA_s2_w.png" alt="aggregation_justification_BRA_s2_w.png" width="600" style="border: 2px solid #ddd; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); margin: 10px 0; cursor: pointer;" />
</a>

*Click image to view full size*

#### **Timeslice Aggregation Justification** - Statistical analysis supporting the selected temporal resolution structure
<a href="VerveStacks_BRA/source_data/aggregation_justification_BRA_s2_w_p2_d.png" target="_blank">
  <img src="VerveStacks_BRA/source_data/aggregation_justification_BRA_s2_w_p2_d.png" alt="aggregation_justification_BRA_s2_w_p2_d.png" width="600" style="border: 2px solid #ddd; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); margin: 10px 0; cursor: pointer;" />
</a>

*Click image to view full size*

#### **Timeslice Aggregation Justification** - Statistical analysis supporting the selected temporal resolution structure
<a href="VerveStacks_BRA/source_data/aggregation_justification_BRA_s3p3v3_d.png" target="_blank">
  <img src="VerveStacks_BRA/source_data/aggregation_justification_BRA_s3p3v3_d.png" alt="aggregation_justification_BRA_s3p3v3_d.png" width="600" style="border: 2px solid #ddd; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); margin: 10px 0; cursor: pointer;" />
</a>

*Click image to view full size*

#### **Timeslice Aggregation Justification** - Statistical analysis supporting the selected temporal resolution structure
<a href="VerveStacks_BRA/source_data/aggregation_justification_BRA_s5p5v5_d.png" target="_blank">
  <img src="VerveStacks_BRA/source_data/aggregation_justification_BRA_s5p5v5_d.png" alt="aggregation_justification_BRA_s5p5v5_d.png" width="600" style="border: 2px solid #ddd; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); margin: 10px 0; cursor: pointer;" />
</a>

*Click image to view full size*

#### **Timeslice Aggregation Justification** - Statistical analysis supporting the selected temporal resolution structure
<a href="VerveStacks_BRA/source_data/aggregation_justification_BRA_ts12_clu.png" target="_blank">
  <img src="VerveStacks_BRA/source_data/aggregation_justification_BRA_ts12_clu.png" alt="aggregation_justification_BRA_ts12_clu.png" width="600" style="border: 2px solid #ddd; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); margin: 10px 0; cursor: pointer;" />
</a>

*Click image to view full size*

#### **Timeslice Aggregation Justification** - Statistical analysis supporting the selected temporal resolution structure
<a href="VerveStacks_BRA/source_data/aggregation_justification_BRA_ts24_clu.png" target="_blank">
  <img src="VerveStacks_BRA/source_data/aggregation_justification_BRA_ts24_clu.png" alt="aggregation_justification_BRA_ts24_clu.png" width="600" style="border: 2px solid #ddd; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); margin: 10px 0; cursor: pointer;" />
</a>

*Click image to view full size*

#### **Timeslice Aggregation Justification** - Statistical analysis supporting the selected temporal resolution structure
<a href="VerveStacks_BRA/source_data/aggregation_justification_BRA_ts48_clu.png" target="_blank">
  <img src="VerveStacks_BRA/source_data/aggregation_justification_BRA_ts48_clu.png" alt="aggregation_justification_BRA_ts48_clu.png" width="600" style="border: 2px solid #ddd; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); margin: 10px 0; cursor: pointer;" />
</a>

*Click image to view full size*

#### **Calendar Year Bra** - Timeslice analysis visualization
<a href="VerveStacks_BRA/source_data/calendar_year_BRA.png" target="_blank">
  <img src="VerveStacks_BRA/source_data/calendar_year_BRA.png" alt="calendar_year_BRA.png" width="600" style="border: 2px solid #ddd; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); margin: 10px 0; cursor: pointer;" />
</a>

*Click image to view full size*

#### **Re Analysis Summary Bra** - Timeslice analysis visualization
<a href="VerveStacks_BRA/source_data/re_analysis_summary_BRA.png" target="_blank">
  <img src="VerveStacks_BRA/source_data/re_analysis_summary_BRA.png" alt="re_analysis_summary_BRA.png" width="600" style="border: 2px solid #ddd; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); margin: 10px 0; cursor: pointer;" />
</a>

*Click image to view full size*

#### **Stress Periods S1 D Bra** - Timeslice analysis visualization
<a href="VerveStacks_BRA/source_data/stress_periods_s1_d_BRA.png" target="_blank">
  <img src="VerveStacks_BRA/source_data/stress_periods_s1_d_BRA.png" alt="stress_periods_s1_d_BRA.png" width="600" style="border: 2px solid #ddd; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); margin: 10px 0; cursor: pointer;" />
</a>

*Click image to view full size*

#### **Stress Periods S2 W Bra** - Timeslice analysis visualization
<a href="VerveStacks_BRA/source_data/stress_periods_s2_w_BRA.png" target="_blank">
  <img src="VerveStacks_BRA/source_data/stress_periods_s2_w_BRA.png" alt="stress_periods_s2_w_BRA.png" width="600" style="border: 2px solid #ddd; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); margin: 10px 0; cursor: pointer;" />
</a>

*Click image to view full size*

#### **Stress Periods S5P5V5 D Bra** - Timeslice analysis visualization
<a href="VerveStacks_BRA/source_data/stress_periods_s5p5v5_d_BRA.png" target="_blank">
  <img src="VerveStacks_BRA/source_data/stress_periods_s5p5v5_d_BRA.png" alt="stress_periods_s5p5v5_d_BRA.png" width="600" style="border: 2px solid #ddd; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); margin: 10px 0; cursor: pointer;" />
</a>

*Click image to view full size*

#### **Renewable Supply Curves** - Cost-ordered renewable resource potential showing solar and wind capacity vs. LCOE
<a href="VerveStacks_BRA/source_data/supply_curves_BRA.png" target="_blank">
  <img src="VerveStacks_BRA/source_data/supply_curves_BRA.png" alt="supply_curves_BRA.png" width="600" style="border: 2px solid #ddd; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); margin: 10px 0; cursor: pointer;" />
</a>
