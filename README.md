...
- **Total Capacity Tracked**: 116.7 GW from all sources
- **Plants Above Threshold**: 305 individual plants tracked above 100 MW threshold
- **Total Plants Processed**: 351 plants in database
...
### Files Included
- **Source Data**: `source_data/VerveStacks_AUS.xlsx` - Raw data reconciliation between sources
...
- 305 plants tracked individually above threshold
