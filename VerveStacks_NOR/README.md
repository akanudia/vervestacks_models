# VerveStacks Model Generation Notes - NOR

**Generated:** 2025-07-31 23:27:36
...
- **Total Capacity Tracked**: 41.6 GW from all sources
- **Plants Above Threshold**: 213 individual plants tracked above 50 MW threshold
- **Total Plants Processed**: 243 plants in database
...
### Files Included
- **Source Data**: `source_data/VerveStacks_NOR.xlsx` - Raw data reconciliation between sources
...
- 213 plants tracked individually above threshold
