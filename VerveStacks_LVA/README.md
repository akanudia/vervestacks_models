...
- **Total Capacity Tracked**: 3.4 GW from all sources
- **Plants Above Threshold**: 14 individual plants tracked above 50 MW threshold
- **Total Plants Processed**: 19 plants in database
...
### Files Included
- **Source Data**: `source_data/VerveStacks_LVA.xlsx` - Raw data reconciliation between sources
...
- 14 plants tracked individually above threshold
