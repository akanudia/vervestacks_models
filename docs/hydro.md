...
## Slovakia Hydro Profile

| Planning Parameter | Value | Application |
|--------------------|-------|-------------|
| **Hydro Dependency** | 15.6% of generation | System vulnerability assessment |
| **P10 (Dry Scenario)** | 29.3% annual average | Security planning, reserve sizing |
| **P50 (Base Scenario)** | 30.7% annual average | Expected case, financial planning |
| **P90 (Wet Scenario)** | 32.6% annual average | Export opportunities, minimum backup |
| **Historical Average** | 30.8% (2000-2023) | Validation benchmark |
| **Drought Threshold** | 28.0% (P20 of historical) | Operational stress indicator |
...
<div align="center">
  <img src="assets/SVK_hydro_monthly_profile.png"
...
<div align="center">
  <img src="assets/SVK_hydro_annual_trajectory.png"
