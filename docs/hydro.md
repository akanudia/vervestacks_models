...
|--------------------|-------|-------------|
| **Hydro Dependency** | 60.4% of generation | System vulnerability assessment |
| **P10 (Dry Scenario)** | 47.2% annual average | Security planning, reserve sizing |
| **P50 (Base Scenario)** | 49.6% annual average | Expected case, financial planning |
| **P90 (Wet Scenario)** | 52.4% annual average | Export opportunities, minimum backup |
...
<div align="center">
  <img src="assets/BRA_hydro_monthly_profile.png"
...
<div align="center">
  <img src="assets/BRA_hydro_annual_trajectory.png"
