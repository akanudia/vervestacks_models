...
## Bosnia Herzegovina Hydro Profile

| Planning Parameter | Value | Application |
|--------------------|-------|-------------|
| **Hydro Dependency** | 36.4% of generation | System vulnerability assessment |
| **P10 (Dry Scenario)** | 36.4% annual average | Security planning, reserve sizing |
| **P50 (Base Scenario)** | 38.1% annual average | Expected case, financial planning |
| **P90 (Wet Scenario)** | 40.5% annual average | Export opportunities, minimum backup |
| **Historical Average** | 37.9% (2000-2023) | Validation benchmark |
| **Drought Threshold** | 30.3% (P20 of historical) | Operational stress indicator |
...
<div align="center">
  <img src="assets/BIH_hydro_monthly_profile.png"
...
<div align="center">
  <img src="assets/BIH_hydro_annual_trajectory.png"
