...
## Australia Hydro Profile

| Planning Parameter | Value | Application |
|--------------------|-------|-------------|
| **Hydro Dependency** | 4.3% of generation | System vulnerability assessment |
| **P10 (Dry Scenario)** | 23.0% annual average | Security planning, reserve sizing |
| **P50 (Base Scenario)** | 23.9% annual average | Expected case, financial planning |
| **P90 (Wet Scenario)** | 25.6% annual average | Export opportunities, minimum backup |
...
<div align="center">
  <img src="assets/AUS_hydro_monthly_profile.png"
...
<div align="center">
  <img src="assets/AUS_hydro_annual_trajectory.png"
