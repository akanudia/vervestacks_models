...
## Turkey Hydro Profile

| Planning Parameter | Value | Application |
|--------------------|-------|-------------|
| **Hydro Dependency** | 16.2% of generation | System vulnerability assessment |
| **P10 (Dry Scenario)** | 28.4% annual average | Security planning, reserve sizing |
| **P50 (Base Scenario)** | 29.9% annual average | Expected case, financial planning |
| **P90 (Wet Scenario)** | 31.6% annual average | Export opportunities, minimum backup |
| **Historical Average** | 29.8% (2000-2023) | Validation benchmark |
| **Drought Threshold** | 24.1% (P20 of historical) | Operational stress indicator |
...
<div align="center">
  <img src="assets/TUR_hydro_monthly_profile.png"
...
<div align="center">
  <img src="assets/TUR_hydro_annual_trajectory.png"
