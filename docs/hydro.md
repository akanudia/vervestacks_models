...
|--------------------|-------|-------------|
| **Hydro Dependency** | 32.0% of generation | System vulnerability assessment |
| **P10 (Dry Scenario)** | 47.1% annual average | Security planning, reserve sizing |
| **P50 (Base Scenario)** | 48.7% annual average | Expected case, financial planning |
| **P90 (Wet Scenario)** | 51.8% annual average | Export opportunities, minimum backup |
