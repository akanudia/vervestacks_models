...
|--------------------|-------|-------------|
| **Hydro Dependency** | 6.3% of generation | System vulnerability assessment |
| **P10 (Dry Scenario)** | 52.5% annual average | Security planning, reserve sizing |
| **P50 (Base Scenario)** | 54.8% annual average | Expected case, financial planning |
| **P90 (Wet Scenario)** | 57.9% annual average | Export opportunities, minimum backup |
| **Historical Average** | 55.2% (2000-2023) | Validation benchmark |
| **Drought Threshold** | 52.7% (P20 of historical) | Operational stress indicator |
...
<div align="center">
  <img src="assets/EGY_hydro_monthly_profile.png"
...
<div align="center">
  <img src="assets/EGY_hydro_annual_trajectory.png"
