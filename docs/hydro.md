...
## Norway Hydro Profile

| Planning Parameter | Value | Application |
|--------------------|-------|-------------|
| **Hydro Dependency** | 88.5% of generation | System vulnerability assessment |
| **P10 (Dry Scenario)** | 46.5% annual average | Security planning, reserve sizing |
| **P50 (Base Scenario)** | 49.4% annual average | Expected case, financial planning |
| **P90 (Wet Scenario)** | 51.6% annual average | Export opportunities, minimum backup |
| **Historical Average** | 48.9% (2000-2023) | Validation benchmark |
| **Drought Threshold** | 45.0% (P20 of historical) | Operational stress indicator |
...
<div align="center">
  <img src="assets/NOR_hydro_monthly_profile.png"
...
<div align="center">
  <img src="assets/NOR_hydro_annual_trajectory.png"
