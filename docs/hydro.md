...
## France Hydro Profile

| Planning Parameter | Value | Application |
|--------------------|-------|-------------|
| **Hydro Dependency** | 10.4% of generation | System vulnerability assessment |
| **P10 (Dry Scenario)** | 26.6% annual average | Security planning, reserve sizing |
| **P50 (Base Scenario)** | 27.9% annual average | Expected case, financial planning |
| **P90 (Wet Scenario)** | 29.4% annual average | Export opportunities, minimum backup |
...
<div align="center">
  <img src="assets/FRA_hydro_monthly_profile.png"
...
<div align="center">
  <img src="assets/FRA_hydro_annual_trajectory.png"
