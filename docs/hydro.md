...
## Morocco Hydro Profile

| Planning Parameter | Value | Application |
|--------------------|-------|-------------|
| **Hydro Dependency** | 1.2% of generation | System vulnerability assessment |
| **P10 (Dry Scenario)** | 14.3% annual average | Security planning, reserve sizing |
| **P50 (Base Scenario)** | 15.1% annual average | Expected case, financial planning |
| **P90 (Wet Scenario)** | 15.8% annual average | Export opportunities, minimum backup |
| **Historical Average** | 14.6% (2000-2023) | Validation benchmark |
| **Drought Threshold** | 9.7% (P20 of historical) | Operational stress indicator |
...
<div align="center">
  <img src="assets/MAR_hydro_monthly_profile.png"
...
<div align="center">
  <img src="assets/MAR_hydro_annual_trajectory.png"
