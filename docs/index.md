...
!!! info "Model Info"
    **Generated:** 2026-08-26 19:39:55  |  **ISO Code:** `HRV`
...
| 💨 **Windon** | 200 MW | 1/8 plants | 1.05 GW | 100% |
...
| Metric | Value |
|--------|-------|
| **Individual Plant Coverage** | 64% of total capacity from plant-level GEM data |
| **Total Capacity Tracked** | 10.4 GW from all sources |
| **Plants Above Threshold** | 29 individual plants tracked |
