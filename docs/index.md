...
!!! info "Model Info"
    **Generated:** 2026-06-25 23:32:30  |  **ISO Code:** `SRB`
...
| 💧 **Hydro Power** | 10 MW | 10/10 plants | 2.49 GW | — | 54% |
| ☀️ **Solar** | 200 MW | 0/10 plants | 0.149 GW | — | 49.1% |
| 💨 **Windon** | 200 MW | 1/6 plants | 0.677 GW | — | 100% |
| 🔋 **Pumped Storage** | 10 MW | 1/1 plants | 0.614 GW | — | 100% |
...
|---------------|---------------|----------------------------|--------------------|-----------------|
| 🔥 **Gas** | 10 MW | 2/2 plants | 1.35 GW | 43.9% |
| ☀️ **Solar** | 200 MW | 3/16 plants | 2.59 GW | 100% |
| 💨 **Windon** | 200 MW | 12/22 plants | 7.58 GW | 100% |
...
| **Total Capacity Tracked** | 24 GW from all sources |
| **Plants Above Threshold** | 59 individual plants tracked |
| **Total Plants Processed** | 97 plants in database |
