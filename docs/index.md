...
| ⚫ **Coal** | 10 MW | 9/9 plants | 0.344 GW | — | 29.7% |
| 🔥 **Gas** | 10 MW | 92/93 plants | 12.9 GW | 0.9 GW | 33.3% |
...
|---------------|---------------|----------------------------|--------------------|-----------------|
| 🌱 **Bioenergy** | 50 MW | 1/2 plants | 0.11 GW | 29.4% |
| ⚫ **Coal** | 10 MW | 2/2 plants | 0.7 GW | 32.1% |
| 🔥 **Gas** | 10 MW | 75/75 plants | 16.7 GW | 38.6% |
...
|------|------------------------|-------------------|
| ⚫ **Coal** | 0.344 GW | 0.193 GW after capacity penalty |
| 🔥 **Gas**  | 13.8 GW  | 11.6 GW after capacity penalty |
...
| **Total Capacity Tracked** | 44.8 GW from all sources |
| **Plants Above Threshold** | 162 individual plants tracked |
| **Total Plants Processed** | 225 plants in database |
...
- **Source Data:** `source_data/VerveStacks_NGA.xlsx` — full dataset in a model-agnostic format
