...
|---------------|---------------|----------------------------|--------------------|--------------------------|-----------------|
| 🌱 **Bioenergy** | 50 MW | 0/1 plants | 0.01 GW | — | 33% |
| ⚫ **Coal** | 10 MW | 10/10 plants | 1.99 GW | 0.1 GW | 34% |
| 💧 **Hydro Power** | 10 MW | 18/18 plants | 1.95 GW | — | 98% |
| ☀️ **Solar** | 200 MW | 0/27 plants | 0.718 GW | — | 97% |
| 💨 **Windon** | 200 MW | 0/7 plants | 0.435 GW | — | 100% |
| 🔋 **Pumped Storage** | 10 MW | 2/2 plants | 0.44 GW | 0.066 GW | 100% |
...
|---------------|---------------|----------------------------|--------------------|-----------------|
| ⚫ **Coal** | 10 MW | 3/3 plants | 1.05 GW | 39.3% |
| 🔥 **Gas** | 10 MW | 2/2 plants | 0.238 GW | 53% |
| 💧 **Hydro Power** | 10 MW | 17/17 plants | 1.87 GW | 100% |
| ☀️ **Solar** | 200 MW | 5/14 plants | 2.16 GW | 100% |
| 💨 **Windon** | 200 MW | 5/10 plants | 2.71 GW | 100% |
| 🔋 **Pumped Storage** | 10 MW | 2/2 plants | 0.652 GW | 100% |
...
|------|------------------------|-------------------|
| ⚫ **Coal** | 2.09 GW | 1.27 GW after capacity penalty |
...
| **Total Capacity Tracked** | 14.4 GW from all sources |
| **Plants Above Threshold** | 51 individual plants tracked |
| **Total Plants Processed** | 113 plants in database |
...
- **Source Data:** `source_data/VerveStacks_BIH.xlsx` — full dataset in a model-agnostic format
