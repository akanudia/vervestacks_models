...
!!! info "Model Info"
    **Generated:** 2026-07-09 13:16:15  |  **ISO Code:** `FRA`
...
|---------------|---------------|----------------------------|--------------------|-----------------|
| 🌱 **Bioenergy** | 50 MW | 14/36 plants | 2.29 GW | 32.8% |
| ⚫ **Coal** | 10 MW | 10/10 plants | 2.51 GW | 35.5% |
| 🔥 **Gas** | 10 MW | 76/76 plants | 17.8 GW | 42.5% |
...
|------|------------------------|-------------------|
| ⚫ **Coal** | 2.51 GW | 1.82 GW after capacity penalty |
...
| **Plants Above Threshold** | 342 individual plants tracked |
| **Total Plants Processed** | 1036 plants in database |
