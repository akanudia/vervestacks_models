...
!!! info "Model Info"
    **Generated:** 2026-06-30 21:03:10  |  **ISO Code:** `POL`
...
|---------------|---------------|----------------------------|--------------------|-----------------|
| 🌱 **Bioenergy** | 50 MW | 13/20 plants | 1.3 GW | 29.1% |
...
| **Plants Above Threshold** | 240 individual plants tracked |
| **Total Plants Processed** | 479 plants in database |
