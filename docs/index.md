...
!!! info "Model Info"
    **Generated:** 2026-06-25 19:58:54  |  **ISO Code:** `ZWE`
...
|---------------|---------------|----------------------------|--------------------|-----------------|
| 🌱 **Bioenergy** | 50 MW | 1/3 plants | 0.122 GW | 33.2% |
...
|---------------|---------------|----------------------------|--------------------|-----------------|
| ⚫ **Coal** | 10 MW | 26/26 plants | 7.75 GW | 31.7% |
...
| **Total Capacity Tracked** | 17.8 GW from all sources |
| **Plants Above Threshold** | 58 individual plants tracked |
| **Total Plants Processed** | 123 plants in database |
