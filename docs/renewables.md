# Renewable Energy Potential — MEX
...
<div align="center">
  <img src="assets/supply_curves_MEX.svg"
...
|------------|-----------|---------|-----------------|------------|
| ☀️ **Solar PV** | 915 | 59 | 15.5 cells | 5 to 33 cells |
| 💨 **Wind Onshore** | 567 | 44 | 12.9 cells | 6 to 32 cells |
| 🌊 **Wind Offshore** | 291 | 30 | 9.7 cells | 3 to 23 cells |

**Grid Definition:** Grid definition: kan15
...
<div align="center">
  <img src="assets/clustering_results_MEX_solar.png"
       alt="Solar PV Clustering" style="max-width:100%; border:1px solid #ddd; border-radius:8px;">
  <p><em>Solar PV: 59 clusters from 915 grid cells</em></p>
</div>

### Wind Onshore Clustering

<div align="center">
  <img src="assets/clustering_results_MEX_wind_onshore.png"
       alt="Onshore Wind Clustering" style="max-width:100%; border:1px solid #ddd; border-radius:8px;">
  <p><em>Wind Onshore: 44 clusters from 567 grid cells</em></p>
</div>

### Wind Offshore Clustering

<div align="center">
  <img src="assets/clustering_results_MEX_wind_offshore.png"
       alt="Offshore Wind Clustering" style="max-width:100%; border:1px solid #ddd; border-radius:8px;">
  <p><em>Wind Offshore: 30 clusters from 291 grid cells</em></p>
</div>
