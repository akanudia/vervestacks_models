# Renewable Energy Potential — SAU
...
<div align="center">
  <img src="assets/supply_curves_SAU.svg"
...
|------------|-----------|---------|-----------------|------------|
| ☀️ **Solar PV** | 897 | 59 | 15.2 cells | 8 to 29 cells |
| 💨 **Wind Onshore** | 867 | 57 | 15.2 cells | 5 to 33 cells |
| 🌊 **Wind Offshore** | 93 | 15 | 6.2 cells | 2 to 10 cells |
...
<div align="center">
  <img src="assets/clustering_results_SAU_solar.png"
       alt="Solar PV Clustering" style="max-width:100%; border:1px solid #ddd; border-radius:8px;">
  <p><em>Solar PV: 59 clusters from 897 grid cells</em></p>
</div>

### Wind Onshore Clustering

<div align="center">
  <img src="assets/clustering_results_SAU_wind_onshore.png"
       alt="Onshore Wind Clustering" style="max-width:100%; border:1px solid #ddd; border-radius:8px;">
  <p><em>Wind Onshore: 57 clusters from 867 grid cells</em></p>
</div>

### Wind Offshore Clustering

<div align="center">
  <img src="assets/clustering_results_SAU_wind_offshore.png"
       alt="Offshore Wind Clustering" style="max-width:100%; border:1px solid #ddd; border-radius:8px;">
  <p><em>Wind Offshore: 15 clusters from 93 grid cells</em></p>
</div>
