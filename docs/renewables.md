# Renewable Energy Potential — NOR
...
<div align="center">
  <img src="assets/supply_curves_NOR.svg"
...
|------------|-----------|---------|-----------------|------------|
| ☀️ **Solar PV** | 40 | 10 | 4.0 cells | 2 to 7 cells |
| 💨 **Wind Onshore** | 39 | 10 | 3.9 cells | 1 to 6 cells |
| 🌊 **Wind Offshore** | 400 | 36 | 11.1 cells | 3 to 20 cells |
...
<div align="center">
  <img src="assets/clustering_results_NOR_solar.png"
       alt="Solar PV Clustering" style="max-width:100%; border:1px solid #ddd; border-radius:8px;">
  <p><em>Solar PV: 10 clusters from 40 grid cells</em></p>
</div>

### Wind Onshore Clustering

<div align="center">
  <img src="assets/clustering_results_NOR_wind_onshore.png"
       alt="Onshore Wind Clustering" style="max-width:100%; border:1px solid #ddd; border-radius:8px;">
  <p><em>Wind Onshore: 10 clusters from 39 grid cells</em></p>
</div>

### Wind Offshore Clustering

<div align="center">
  <img src="assets/clustering_results_NOR_wind_offshore.png"
       alt="Offshore Wind Clustering" style="max-width:100%; border:1px solid #ddd; border-radius:8px;">
  <p><em>Wind Offshore: 36 clusters from 400 grid cells</em></p>
</div>
