# Renewable Energy Potential — TUR
...
<div align="center">
  <img src="assets/supply_curves_TUR.svg"
...
|------------|-----------|---------|-----------------|------------|
| ☀️ **Solar PV** | 373 | 34 | 11.0 cells | 2 to 30 cells |
| 💨 **Wind Onshore** | 161 | 27 | 6.0 cells | 1 to 19 cells |
| 🌊 **Wind Offshore** | 62 | 15 | 4.1 cells | 1 to 9 cells |
...
<div align="center">
  <img src="assets/clustering_results_TUR_solar.png"
       alt="Solar PV Clustering" style="max-width:100%; border:1px solid #ddd; border-radius:8px;">
  <p><em>Solar PV: 34 clusters from 373 grid cells</em></p>
</div>

### Wind Onshore Clustering

<div align="center">
  <img src="assets/clustering_results_TUR_wind_onshore.png"
       alt="Onshore Wind Clustering" style="max-width:100%; border:1px solid #ddd; border-radius:8px;">
  <p><em>Wind Onshore: 27 clusters from 161 grid cells</em></p>
</div>

### Wind Offshore Clustering

<div align="center">
  <img src="assets/clustering_results_TUR_wind_offshore.png"
       alt="Offshore Wind Clustering" style="max-width:100%; border:1px solid #ddd; border-radius:8px;">
  <p><em>Wind Offshore: 15 clusters from 62 grid cells</em></p>
</div>
