...
|------------|-----------|---------|-----------------|------------|
| ☀️ **Solar PV** | 40 | 18 | 2.2 cells | 1 to 4 cells |
| 💨 **Wind Onshore** | 39 | 17 | 2.3 cells | 1 to 4 cells |
| 🌊 **Wind Offshore** | 404 | 36 | 11.2 cells | 1 to 39 cells |
...
<div align="center">
  ...
  <p><em>Solar PV: 18 clusters from 40 grid cells</em></p>
</div>
...
<div align="center">
  ...
  <p><em>Wind Onshore: 17 clusters from 39 grid cells</em></p>
</div>
...
<div align="center">
  ...
  <p><em>Wind Offshore: 36 clusters from 404 grid cells</em></p>
</div>
