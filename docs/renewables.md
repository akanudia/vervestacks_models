# Renewable Energy Potential — EGY
...
<div align="center">
  <img src="assets/supply_curves_EGY.svg"
...
|------------|-----------|---------|-----------------|------------|
| ☀️ **Solar PV** | 455 | 39 | 11.7 cells | 4 to 23 cells |
| 💨 **Wind Onshore** | 455 | 39 | 11.7 cells | 3 to 29 cells |
| 🌊 **Wind Offshore** | 80 | 13 | 6.2 cells | 2 to 10 cells |
...
<div align="center">
  <img src="assets/clustering_results_EGY_solar.png"
       alt="Solar PV Clustering" style="max-width:100%; border:1px solid #ddd; border-radius:8px;">
  <p><em>Solar PV: 39 clusters from 455 grid cells</em></p>
</div>

### Wind Onshore Clustering

<div align="center">
  <img src="assets/clustering_results_EGY_wind_onshore.png"
       alt="Onshore Wind Clustering" style="max-width:100%; border:1px solid #ddd; border-radius:8px;">
  <p><em>Wind Onshore: 39 clusters from 455 grid cells</em></p>
</div>

### Wind Offshore Clustering

<div align="center">
  <img src="assets/clustering_results_EGY_wind_offshore.png"
       alt="Offshore Wind Clustering" style="max-width:100%; border:1px solid #ddd; border-radius:8px;">
  <p><em>Wind Offshore: 13 clusters from 80 grid cells</em></p>
</div>
