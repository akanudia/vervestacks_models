# Renewable Energy Potential — KEN
...
<div align="center">
  <img src="assets/supply_curves_KEN.svg"
...
|------------|-----------|---------|-----------------|------------|
| ☀️ **Solar PV** | 273 | 28 | 9.8 cells | 2 to 30 cells |
| 💨 **Wind Onshore** | 198 | 23 | 8.6 cells | 1 to 22 cells |
| 🌊 **Wind Offshore** | 22 | 10 | 2.2 cells | 1 to 4 cells |
...
<div align="center">
  <img src="assets/clustering_results_KEN_solar.png"
       alt="Solar PV Clustering" style="max-width:100%; border:1px solid #ddd; border-radius:8px;">
  <p><em>Solar PV: 28 clusters from 273 grid cells</em></p>
</div>

### Wind Onshore Clustering

<div align="center">
  <img src="assets/clustering_results_KEN_wind_onshore.png"
       alt="Onshore Wind Clustering" style="max-width:100%; border:1px solid #ddd; border-radius:8px;">
  <p><em>Wind Onshore: 23 clusters from 198 grid cells</em></p>
</div>

### Wind Offshore Clustering

<div align="center">
  <img src="assets/clustering_results_KEN_wind_offshore.png"
       alt="Offshore Wind Clustering" style="max-width:100%; border:1px solid #ddd; border-radius:8px;">
  <p><em>Wind Offshore: 10 clusters from 22 grid cells</em></p>
</div>
