# Renewable Energy Potential — CHN
...
<div align="center">
  <img src="assets/supply_curves_CHN.svg"
...
|------------|-----------|---------|-----------------|------------|
| ☀️ **Solar PV** | 3601 | 136 | 26.5 cells | 5 to 86 cells |
| 💨 **Wind Onshore** | 2716 | 114 | 23.8 cells | 6 to 64 cells |
| 🌊 **Wind Offshore** | 369 | 34 | 10.9 cells | 1 to 24 cells |
...
<div align="center">
  <img src="assets/clustering_results_CHN_solar.png"
       alt="Solar PV Clustering" style="max-width:100%; border:1px solid #ddd; border-radius:8px;">
  <p><em>Solar PV: 136 clusters from 3601 grid cells</em></p>
</div>

### Wind Onshore Clustering

<div align="center">
  <img src="assets/clustering_results_CHN_wind_onshore.png"
       alt="Onshore Wind Clustering" style="max-width:100%; border:1px solid #ddd; border-radius:8px;">
  <p><em>Wind Onshore: 114 clusters from 2716 grid cells</em></p>
</div>

### Wind Offshore Clustering

<div align="center">
  <img src="assets/clustering_results_CHN_wind_offshore.png"
       alt="Offshore Wind Clustering" style="max-width:100%; border:1px solid #ddd; border-radius:8px;">
  <p><em>Wind Offshore: 34 clusters from 369 grid cells</em></p>
</div>
