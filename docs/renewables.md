# Renewable Energy Potential — GBR
...
<div align="center">
  <img src="assets/supply_curves_GBR.svg"
...
|------------|-----------|---------|-----------------|------------|
| ☀️ **Solar PV** | 167 | 21 | 8.0 cells | 4 to 12 cells |
| 💨 **Wind Onshore** | 171 | 21 | 8.1 cells | 3 to 16 cells |
| 🌊 **Wind Offshore** | 363 | 34 | 10.7 cells | 2 to 16 cells |
...
<div align="center">
  <img src="assets/clustering_results_GBR_solar.png"
       alt="Solar PV Clustering" style="max-width:100%; border:1px solid #ddd; border-radius:8px;">
  <p><em>Solar PV: 21 clusters from 167 grid cells</em></p>
</div>

### Wind Onshore Clustering

<div align="center">
  <img src="assets/clustering_results_GBR_wind_onshore.png"
       alt="Onshore Wind Clustering" style="max-width:100%; border:1px solid #ddd; border-radius:8px;">
  <p><em>Wind Onshore: 21 clusters from 171 grid cells</em></p>
</div>

### Wind Offshore Clustering

<div align="center">
  <img src="assets/clustering_results_GBR_wind_offshore.png"
       alt="Offshore Wind Clustering" style="max-width:100%; border:1px solid #ddd; border-radius:8px;">
  <p><em>Wind Offshore: 34 clusters from 363 grid cells</em></p>
</div>
