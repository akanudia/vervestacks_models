# Renewable Energy Potential — IRL
...
<div align="center">
  <img src="assets/supply_curves_IRL.svg"
...
|------------|-----------|---------|-----------------|------------|
| ☀️ **Solar PV** | 42 | 10 | 4.2 cells | 2 to 6 cells |
| 💨 **Wind Onshore** | 42 | 10 | 4.2 cells | 2 to 8 cells |
| 🌊 **Wind Offshore** | 124 | 18 | 6.9 cells | 2 to 10 cells |
...
<div align="center">
  <img src="assets/clustering_results_IRL_solar.png"
       alt="Solar PV Clustering" style="max-width:100%; border:1px solid #ddd; border-radius:8px;">
  <p><em>Solar PV: 10 clusters from 42 grid cells</em></p>
</div>

### Wind Onshore Clustering

<div align="center">
  <img src="assets/clustering_results_IRL_wind_onshore.png"
       alt="Onshore Wind Clustering" style="max-width:100%; border:1px solid #ddd; border-radius:8px;">
  <p><em>Wind Onshore: 10 clusters from 42 grid cells</em></p>
</div>

### Wind Offshore Clustering

<div align="center">
  <img src="assets/clustering_results_IRL_wind_offshore.png"
       alt="Offshore Wind Clustering" style="max-width:100%; border:1px solid #ddd; border-radius:8px;">
  <p><em>Wind Offshore: 18 clusters from 124 grid cells</em></p>
</div>
