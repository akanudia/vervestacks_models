# Renewable Energy Potential — DEU
...
<div align="center">
  <img src="assets/supply_curves_DEU.svg"
...
|------------|-----------|---------|-----------------|------------|
| ☀️ **Solar PV** | 188 | 23 | 8.2 cells | 4 to 14 cells |
| 💨 **Wind Onshore** | 182 | 22 | 8.3 cells | 2 to 17 cells |
| 🌊 **Wind Offshore** | 38 | 10 | 3.8 cells | 1 to 8 cells |
...
<div align="center">
  <img src="assets/clustering_results_DEU_solar.png"
       alt="Solar PV Clustering" style="max-width:100%; border:1px solid #ddd; border-radius:8px;">
  <p><em>Solar PV: 23 clusters from 188 grid cells</em></p>
</div>

### Wind Onshore Clustering

<div align="center">
  <img src="assets/clustering_results_DEU_wind_onshore.png"
       alt="Onshore Wind Clustering" style="max-width:100%; border:1px solid #ddd; border-radius:8px;">
  <p><em>Wind Onshore: 22 clusters from 182 grid cells</em></p>
</div>

### Wind Offshore Clustering

<div align="center">
  <img src="assets/clustering_results_DEU_wind_offshore.png"
       alt="Offshore Wind Clustering" style="max-width:100%; border:1px solid #ddd; border-radius:8px;">
  <p><em>Wind Offshore: 10 clusters from 38 grid cells</em></p>
</div>
