# Renewable Energy Potential — NGA
...
<div align="center">
  <img src="assets/supply_curves_NGA.svg"
...
|------------|-----------|---------|-----------------|------------|
| ☀️ **Solar PV** | 409 | 36 | 11.4 cells | 2 to 30 cells |
| 💨 **Wind Onshore** | 247 | 27 | 9.1 cells | 1 to 21 cells |
| 🌊 **Wind Offshore** | 43 | 10 | 4.3 cells | 1 to 9 cells |
...
<div align="center">
  <img src="assets/clustering_results_NGA_solar.png"
       alt="Solar PV Clustering" style="max-width:100%; border:1px solid #ddd; border-radius:8px;">
  <p><em>Solar PV: 36 clusters from 409 grid cells</em></p>
</div>

### Wind Onshore Clustering

<div align="center">
  <img src="assets/clustering_results_NGA_wind_onshore.png"
       alt="Onshore Wind Clustering" style="max-width:100%; border:1px solid #ddd; border-radius:8px;">
  <p><em>Wind Onshore: 27 clusters from 247 grid cells</em></p>
</div>

### Wind Offshore Clustering

<div align="center">
  <img src="assets/clustering_results_NGA_wind_offshore.png"
       alt="Offshore Wind Clustering" style="max-width:100%; border:1px solid #ddd; border-radius:8px;">
  <p><em>Wind Offshore: 10 clusters from 43 grid cells</em></p>
</div>
