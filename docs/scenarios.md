# Climate Scenarios — BRA

---

## AR6 Scenario Coverage — R10LATIN_AM

This model incorporates climate scenario drivers from the IPCC AR6 database for the **R10LATIN_AM**
...
| **Regional Scope** | R10LATIN_AM | IPCC R10 regional classification |
...
<div align="center">
  <img src="assets/ar6_scenarios_BRA.png"
...
from $221 to $0/tCO₂ by 2030 under ambitious vs. limited
action scenarios. By 2050, this gap widens to $582–$0/tCO₂.

**Electrification Acceleration:** Total electricity demand grows by 3.0× under
ambitious climate scenarios (C1) compared to 2.6× under limited action (C7)
...
- **High Convergence** — CO₂ pricing (CV: inf%) and electricity growth (CV: 21.6%)
- **Moderate Uncertainty** — Transport electrification rates (CV: 120.0%)
- **High Divergence** — Hydrogen deployment pathways (CV: inf%)

The **R10LATIN_AM** region shows moderate convergence compared to global averages,
