# Climate Scenarios — CHN

---

## AR6 Scenario Coverage — R10CHINA+

This model incorporates climate scenario drivers from the IPCC AR6 database for the **R10CHINA+**
...
| **Regional Scope** | R10CHINA+ | IPCC R10 regional classification |
...
<div align="center">
  <img src="assets/ar6_scenarios_CHN.png"
...
from $194 to $0/tCO₂ by 2030 under ambitious vs. limited
...
ambitious climate scenarios (C1) compared to 1.8× under limited action (C7)
...
- **High Convergence** — CO₂ pricing (CV: inf%) and electricity growth (CV: 18.6%)
- **Moderate Uncertainty** — Transport electrification rates (CV: 71.6%)
- **High Divergence** — Hydrogen deployment pathways (CV: 146.3%)

The **R10CHINA+** region shows moderate convergence compared to global averages,
