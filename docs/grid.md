...
<div align="center">
  <img src="assets/TUR_network_visualization.svg"
...
|--------|-------|-------------|
| **Total Buses** | 31 | Transmission substations and connection points |
| **Transmission Lines** | 58 | High-voltage transmission corridors |

## Power Plant Integration

| Integration Type | Count | Description |
|------------------|-------|-------------|
| **Plants Mapped to Buses** | 3607 | GEM power plants assigned to grid locations |
...
|----------------|-------|--------|
| **Grid Cells** | 596 | 50×50 km renewable energy zones |
| **Solar / Wind Onshore Zones** | 537 | Grid cells with solar and onshore wind potential |
| **Wind Offshore Zones** | 178 | Grid cells with offshore wind potential |
| **Zone–Bus Mappings** | 718 | REZoning zones assigned to transmission buses |
...
|--------------------------|-----------------|-----------------|-------------|
| **Demand-Region Clustering** | 26 | 1.0 | Population-weighted clusters mapped to nearest buses |

<div align="center">
  <img src="assets/TUR_demand_bus_verification.png"
       alt="Demand-region to bus mapping verification" style="max-width:100%;">
</div>

### Load Concentration

- **Highest Load Bus:** way/52613323-380 (0.226 share)
- **Load Distribution CV:** 113.6% (coefficient of variation across buses with non-zero demand)
