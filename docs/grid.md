...
<div align="center">
  <img src="assets/MEX_network_visualization.svg"
...
|------------------|-------|-------------|
| **Plants Mapped to Buses** | 511 | GEM power plants assigned to grid locations |
...
|----------------|-------|--------|
| **Grid Cells** | 1773 | 50×50 km renewable energy zones |
| **Solar / Wind Onshore Zones** | 1056 | Grid cells with solar and onshore wind potential |
| **Wind Offshore Zones** | 423 | Grid cells with offshore wind potential |
| **Zone–Bus Mappings** | 1482 | REZoning zones assigned to transmission buses |
...
<div align="center">
  <img src="assets/MEX_demand_bus_verification.png"
       alt="Demand-region to bus mapping verification" style="max-width:100%;">
</div>

### Load Concentration

- **Highest Load Bus:** way/107621341-400 (0.358 share)
- **Load Distribution CV:** 115.8% (coefficient of variation across buses with non-zero demand)
