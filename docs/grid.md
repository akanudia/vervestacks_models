...
<div align="center">
  <img src="assets/FRA_network_visualization.svg"
...
| **Transmission Lines** | 40 | High-voltage transmission corridors |

## Power Plant Integration

| Integration Type | Count | Description |
|------------------|-------|-------------|
| **Plants Mapped to Buses** | 3740 | GEM power plants assigned to grid locations |
...
|----------------|-------|--------|
| **Grid Cells** | 677 | 50×50 km renewable energy zones |
| **Solar / Wind Onshore Zones** | 391 | Grid cells with solar and onshore wind potential |
| **Wind Offshore Zones** | 128 | Grid cells with offshore wind potential |
| **Zone–Bus Mappings** | 522 | REZoning zones assigned to transmission buses |
...
|--------------------------|-----------------|-----------------|-------------|
| **Demand-Region Clustering** | 13 | 1.0 | Population-weighted clusters mapped to nearest buses |

<div align="center">
  <img src="assets/FRA_demand_bus_verification.png"
       alt="Demand-region to bus mapping verification" style="max-width:100%;">
</div>

### Load Concentration

- **Highest Load Bus:** way/85047359-400 (0.48 share)
- **Load Distribution CV:** 153.4% (coefficient of variation across buses with non-zero demand)
