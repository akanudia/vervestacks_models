...
|--------------------------|-----------------|-----------------|-------------|
| **Demand-Region Clustering** | 25 | 1.0 | Population-weighted clusters mapped to nearest buses |
...
- **Highest Load Bus:** way/247861059-765 (0.12 share)
- **Load Distribution CV:** 65.2% (coefficient of variation across buses with non-zero demand)
