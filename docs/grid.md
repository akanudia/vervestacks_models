...
<div align="center">
  <img src="assets/EGY_network_visualization.svg"
...
|------------------|-------|-------------|
| **Plants Mapped to Buses** | 160 | GEM power plants assigned to grid locations |
...
|----------------|-------|--------|
| **Grid Cells** | 990 | 50×50 km renewable energy zones |
| **Solar / Wind Onshore Zones** | 707 | Grid cells with solar and onshore wind potential |
| **Wind Offshore Zones** | 165 | Grid cells with offshore wind potential |
| **Zone–Bus Mappings** | 873 | REZoning zones assigned to transmission buses |
...
<div align="center">
  <img src="assets/EGY_demand_bus_verification.png"
       alt="Demand-region to bus mapping verification" style="max-width:100%;">
</div>

### Load Concentration

- **Highest Load Bus:** way/218893323-220 (0.59 share)
- **Load Distribution CV:** 168.7% (coefficient of variation across buses with non-zero demand)
