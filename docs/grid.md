...
<div align="center">
  <img src="assets/NOR_network_visualization.svg"
...
|--------|-------|-------------|
| **Total Buses** | 295 | Transmission substations and connection points |
| **Transmission Lines** | 411 | High-voltage transmission corridors |

## Power Plant Integration

| Integration Type | Count | Description |
|------------------|-------|-------------|
| **Plants Mapped to Buses** | 263 | GEM power plants assigned to grid locations |
...
|----------------|-------|--------|
| **Grid Cells** | 479 | 50×50 km renewable energy zones |
| **Solar / Wind Onshore Zones** | 145 | Grid cells with solar and onshore wind potential |
| **Wind Offshore Zones** | 623 | Grid cells with offshore wind potential |
| **Zone–Bus Mappings** | 804 | REZoning zones assigned to transmission buses |
...
<div align="center">
  <img src="assets/NOR_demand_bus_verification.png"
       alt="Demand-region to bus mapping verification" style="max-width:100%;">
</div>

### Load Concentration

- **Highest Load Bus:** way/100151486-420 (0.375 share)
- **Load Distribution CV:** 108.4% (coefficient of variation across buses with non-zero demand)
