...
<div align="center">
  <img src="assets/IRL_network_visualization.svg"
...
|------------------|-------|-------------|
| **Plants Mapped to Buses** | 335 | GEM power plants assigned to grid locations |
...
|----------------|-------|--------|
| **Grid Cells** | 208 | 50×50 km renewable energy zones |
| **Solar / Wind Onshore Zones** | 82 | Grid cells with solar and onshore wind potential |
| **Wind Offshore Zones** | 141 | Grid cells with offshore wind potential |
| **Zone–Bus Mappings** | 223 | REZoning zones assigned to transmission buses |
...
<div align="center">
  <img src="assets/IRL_demand_bus_verification.png"
       alt="Demand-region to bus mapping verification" style="max-width:100%;">
</div>

### Load Concentration

- **Highest Load Bus:** way/27144164-220 (0.645 share)
- **Load Distribution CV:** 172.6% (coefficient of variation across buses with non-zero demand)
