...
<div align="center">
  <img src="assets/GBR_network_visualization.svg"
...
|--------|-------|-------------|
| **Total Buses** | 258 | Transmission substations and connection points |
| **Transmission Lines** | 326 | High-voltage transmission corridors |

## Power Plant Integration

| Integration Type | Count | Description |
|------------------|-------|-------------|
| **Plants Mapped to Buses** | 3519 | GEM power plants assigned to grid locations |
...
|----------------|-------|--------|
| **Grid Cells** | 701 | 50×50 km renewable energy zones |
| **Solar / Wind Onshore Zones** | 350 | Grid cells with solar and onshore wind potential |
| **Wind Offshore Zones** | 384 | Grid cells with offshore wind potential |
| **Zone–Bus Mappings** | 734 | REZoning zones assigned to transmission buses |
...
|--------------------------|-----------------|-----------------|-------------|
| **Demand-Region Clustering** | 54 | 1.0 | Population-weighted clusters mapped to nearest buses |
...
- **Highest Load Bus:** way/447301159-400 (0.229 share)
- **Load Distribution CV:** 171.0% (coefficient of variation across buses with non-zero demand)
