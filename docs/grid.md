...
<div align="center">
  <img src="assets/BRA_network_visualization.svg"
...
|--------|-------|-------------|
| **Total Buses** | 23 | Transmission substations and connection points |
| **Transmission Lines** | 37 | High-voltage transmission corridors |

## Power Plant Integration

| Integration Type | Count | Description |
|------------------|-------|-------------|
| **Plants Mapped to Buses** | 3577 | GEM power plants assigned to grid locations |
...
|----------------|-------|--------|
| **Grid Cells** | 4231 | 50×50 km renewable energy zones |
| **Solar / Wind Onshore Zones** | 2923 | Grid cells with solar and onshore wind potential |
| **Wind Offshore Zones** | 360 | Grid cells with offshore wind potential |
| **Zone–Bus Mappings** | 3285 | REZoning zones assigned to transmission buses |
...
|--------------------------|-----------------|-----------------|-------------|
| **Demand-Region Clustering** | 23 | 1.0 | Population-weighted clusters mapped to nearest buses |

<div align="center">
  <img src="assets/BRA_demand_bus_verification.png"
       alt="Demand-region to bus mapping verification" style="max-width:100%;">
</div>

### Load Concentration

- **Highest Load Bus:** BR669-500 (0.24 share)
- **Load Distribution CV:** 107.2% (coefficient of variation across buses with non-zero demand)
