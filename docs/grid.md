...
<div align="center">
  <img src="assets/CHN_network_visualization.svg"
...
|------------------|-------|-------------|
| **Plants Mapped to Buses** | 26132 | GEM power plants assigned to grid locations |
...
|----------------|-------|--------|
| **Grid Cells** | 6686 | 50×50 km renewable energy zones |
| **Solar / Wind Onshore Zones** | 5881 | Grid cells with solar and onshore wind potential |
| **Wind Offshore Zones** | 389 | Grid cells with offshore wind potential |
| **Zone–Bus Mappings** | 6304 | REZoning zones assigned to transmission buses |
...
<div align="center">
  <img src="assets/CHN_demand_bus_verification.png"
       alt="Demand-region to bus mapping verification" style="max-width:100%;">
</div>

### Load Concentration

- **Highest Load Bus:** way/966809494-500 (0.139 share)
- **Load Distribution CV:** 30.9% (coefficient of variation across buses with non-zero demand)
