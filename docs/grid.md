...
<div align="center">
  <img src="assets/GHA_network_visualization.svg"
...
|--------|-------|-------------|
| **Total Buses** | 9 | Transmission substations and connection points |
| **Transmission Lines** | 7 | High-voltage transmission corridors |

## Power Plant Integration

| Integration Type | Count | Description |
|------------------|-------|-------------|
| **Plants Mapped to Buses** | 44 | GEM power plants assigned to grid locations |
...
|----------------|-------|--------|
| **Grid Cells** | 177 | 50×50 km renewable energy zones |
| **Solar / Wind Onshore Zones** | 122 | Grid cells with solar and onshore wind potential |
| **Wind Offshore Zones** | 22 | Grid cells with offshore wind potential |
| **Zone–Bus Mappings** | 147 | REZoning zones assigned to transmission buses |
...
<div align="center">
  <img src="assets/GHA_demand_bus_verification.png"
       alt="Demand-region to bus mapping verification" style="max-width:100%;">
</div>

### Load Concentration

- **Highest Load Bus:** way/1155380911-330 (0.567 share)
- **Load Distribution CV:** 93.4% (coefficient of variation across buses with non-zero demand)
