...
<div align="center">
  <img src="assets/NGA_network_visualization.svg"
...
|--------|-------|-------------|
| **Total Buses** | 15 | Transmission substations and connection points |
...
|------------------|-------|-------------|
| **Plants Mapped to Buses** | 93 | GEM power plants assigned to grid locations |
...
|----------------|-------|--------|
| **Grid Cells** | 699 | 50×50 km renewable energy zones |
| **Solar / Wind Onshore Zones** | 433 | Grid cells with solar and onshore wind potential |
| **Wind Offshore Zones** | 48 | Grid cells with offshore wind potential |
| **Zone–Bus Mappings** | 482 | REZoning zones assigned to transmission buses |
...
<div align="center">
  <img src="assets/NGA_demand_bus_verification.png"
       alt="Demand-region to bus mapping verification" style="max-width:100%;">
</div>

### Load Concentration

- **Highest Load Bus:** NG9-330 (0.315 share)
- **Load Distribution CV:** 97.5% (coefficient of variation across buses with non-zero demand)
