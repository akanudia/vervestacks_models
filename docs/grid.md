...
|------------------|-------|-------------|
| **Plants Mapped to Buses** | 10081 | GEM power plants assigned to grid locations |
...
- **Highest Load Bus:** way/168727982-500 (0.362 share)
- **Load Distribution CV:** 130.9% (coefficient of variation across buses with non-zero demand)
