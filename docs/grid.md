...
<div align="center">
  <img src="assets/ESP_network_visualization.svg"
...
|--------|-------|-------------|
| **Total Buses** | 24 | Transmission substations and connection points |
...
|------------------|-------|-------------|
| **Plants Mapped to Buses** | 4216 | GEM power plants assigned to grid locations |
...
|----------------|-------|--------|
| **Grid Cells** | 580 | 50×50 km renewable energy zones |
| **Solar / Wind Onshore Zones** | 370 | Grid cells with solar and onshore wind potential |
| **Wind Offshore Zones** | 198 | Grid cells with offshore wind potential |
| **Zone–Bus Mappings** | 579 | REZoning zones assigned to transmission buses |
...
|--------------------------|-----------------|-----------------|-------------|
| **Demand-Region Clustering** | 19 | 1.0 | Population-weighted clusters mapped to nearest buses |

<div align="center">
  <img src="assets/ESP_demand_bus_verification.png"
       alt="Demand-region to bus mapping verification" style="max-width:100%;">
</div>

### Load Concentration

- **Highest Load Bus:** way/28308003-220 (0.231 share)
- **Load Distribution CV:** 115.4% (coefficient of variation across buses with non-zero demand)
