...
<div align="center">
  <img src="assets/CHE_network_visualization.svg"
...
|--------|-------|-------------|
| **Total Buses** | 22 | Transmission substations and connection points |
...
|------------------|-------|-------------|
| **Plants Mapped to Buses** | 175 | GEM power plants assigned to grid locations |
...
|----------------|-------|--------|
| **Grid Cells** | 225 | 50×50 km renewable energy zones |
| **Solar / Wind Onshore Zones** | 219 | Grid cells with solar and onshore wind potential |
| **Wind Offshore Zones** | 0 | Grid cells with offshore wind potential |
| **Zone–Bus Mappings** | 225 | REZoning zones assigned to transmission buses |
...
|--------------------------|-----------------|-----------------|-------------|
| **Demand-Region Clustering** | 22 | 1.0 | Population-weighted clusters mapped to nearest buses |

<div align="center">
  <img src="assets/CHE_demand_bus_verification.png"
       alt="Demand-region to bus mapping verification" style="max-width:100%;">
</div>

### Load Concentration

- **Highest Load Bus:** way/147714395-220 (0.182 share)
- **Load Distribution CV:** 88.9% (coefficient of variation across buses with non-zero demand)
