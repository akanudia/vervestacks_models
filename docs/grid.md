...
<div align="center">
  <img src="assets/SVK_network_visualization.svg"
...
| **Transmission Lines** | 69 | High-voltage transmission corridors |

## Power Plant Integration

| Integration Type | Count | Description |
|------------------|-------|-------------|
| **Plants Mapped to Buses** | 170 | GEM power plants assigned to grid locations |
...
|----------------|-------|--------|
| **Grid Cells** | 65 | 50×50 km renewable energy zones |
| **Solar / Wind Onshore Zones** | 57 | Grid cells with solar and onshore wind potential |
| **Wind Offshore Zones** | 0 | Grid cells with offshore wind potential |
| **Zone–Bus Mappings** | 65 | REZoning zones assigned to transmission buses |
...
|--------------------------|-----------------|-----------------|-------------|
| **Demand-Region Clustering** | 8 | 1.0 | Population-weighted clusters mapped to nearest buses |

<div align="center">
  <img src="assets/SVK_demand_bus_verification.png"
       alt="Demand-region to bus mapping verification" style="max-width:100%;">
</div>

### Load Concentration

- **Highest Load Bus:** way/5131796-400 (0.273 share)
- **Load Distribution CV:** 50.6% (coefficient of variation across buses with non-zero demand)
