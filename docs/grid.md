...
<div align="center">
  <img src="assets/ETH_network_visualization.svg"
...
|------------------|-------|-------------|
| **Plants Mapped to Buses** | 56 | GEM power plants assigned to grid locations |
...
|----------------|-------|--------|
| **Grid Cells** | 559 | 50×50 km renewable energy zones |
| **Solar / Wind Onshore Zones** | 556 | Grid cells with solar and onshore wind potential |
| **Wind Offshore Zones** | 0 | Grid cells with offshore wind potential |
| **Zone–Bus Mappings** | 559 | REZoning zones assigned to transmission buses |
...
<div align="center">
  <img src="assets/ETH_demand_bus_verification.png"
       alt="Demand-region to bus mapping verification" style="max-width:100%;">
</div>

### Load Concentration

- **Highest Load Bus:** way/576081254-400 (0.453 share)
- **Load Distribution CV:** 122.3% (coefficient of variation across buses with non-zero demand)
