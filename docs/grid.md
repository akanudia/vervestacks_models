...
<div align="center">
  <img src="assets/KEN_network_visualization.svg"
...
|------------------|-------|-------------|
| **Plants Mapped to Buses** | 75 | GEM power plants assigned to grid locations |
...
|----------------|-------|--------|
| **Grid Cells** | 493 | 50×50 km renewable energy zones |
| **Solar / Wind Onshore Zones** | 290 | Grid cells with solar and onshore wind potential |
| **Wind Offshore Zones** | 24 | Grid cells with offshore wind potential |
| **Zone–Bus Mappings** | 315 | REZoning zones assigned to transmission buses |
...
<div align="center">
  <img src="assets/KEN_demand_bus_verification.png"
       alt="Demand-region to bus mapping verification" style="max-width:100%;">
</div>

### Load Concentration

- **Highest Load Bus:** way/180021151-220 (0.604 share)
- **Load Distribution CV:** 137.2% (coefficient of variation across buses with non-zero demand)
