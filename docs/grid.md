...
<div align="center">
  <img src="assets/MAR_network_visualization.svg"
...
|------------------|-------|-------------|
| **Plants Mapped to Buses** | 91 | GEM power plants assigned to grid locations |
...
|----------------|-------|--------|
| **Grid Cells** | 433 | 50×50 km renewable energy zones |
| **Solar / Wind Onshore Zones** | 332 | Grid cells with solar and onshore wind potential |
| **Wind Offshore Zones** | 137 | Grid cells with offshore wind potential |
| **Zone–Bus Mappings** | 491 | REZoning zones assigned to transmission buses |
...
<div align="center">
  <img src="assets/MAR_demand_bus_verification.png"
       alt="Demand-region to bus mapping verification" style="max-width:100%;">
</div>

### Load Concentration

- **Highest Load Bus:** way/131902940-225 (0.216 share)
- **Load Distribution CV:** 74.4% (coefficient of variation across buses with non-zero demand)
