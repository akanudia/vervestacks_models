...
<div align="center">
  <img src="assets/BIH_network_visualization.svg"
...
|------------------|-------|-------------|
| **Plants Mapped to Buses** | 166 | GEM power plants assigned to grid locations |
...
|----------------|-------|--------|
| **Grid Cells** | 125 | 50×50 km renewable energy zones |
| **Solar / Wind Onshore Zones** | 105 | Grid cells with solar and onshore wind potential |
| **Wind Offshore Zones** | 3 | Grid cells with offshore wind potential |
| **Zone–Bus Mappings** | 125 | REZoning zones assigned to transmission buses |
...
|--------------------------|-----------------|-----------------|-------------|
| **Demand-Region Clustering** | 3 | 1.0 | Population-weighted clusters mapped to nearest buses |

<div align="center">
  <img src="assets/BIH_demand_bus_verification.png"
