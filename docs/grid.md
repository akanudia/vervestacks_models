...
<div align="center">
  <img src="assets/SAU_network_visualization.svg"
...
|------------------|-------|-------------|
| **Plants Mapped to Buses** | 158 | GEM power plants assigned to grid locations |
...
|----------------|-------|--------|
| **Grid Cells** | 1857 | 50×50 km renewable energy zones |
| **Solar / Wind Onshore Zones** | 1171 | Grid cells with solar and onshore wind potential |
| **Wind Offshore Zones** | 146 | Grid cells with offshore wind potential |
| **Zone–Bus Mappings** | 1319 | REZoning zones assigned to transmission buses |
...
<div align="center">
  <img src="assets/SAU_demand_bus_verification.png"
       alt="Demand-region to bus mapping verification" style="max-width:100%;">
</div>

### Load Concentration

- **Highest Load Bus:** way/115168488-380 (0.372 share)
- **Load Distribution CV:** 67.0% (coefficient of variation across buses with non-zero demand)
