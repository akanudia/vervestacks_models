...
|------------------|-------|-------------|
| **Plants Mapped to Buses** | 440 | GEM power plants assigned to grid locations |
...
|----------------|-------|--------|
| **Grid Cells** | 483 | 50×50 km renewable energy zones |
...
- **Highest Load Bus:** relation/10308957-300 (0.375 share)
