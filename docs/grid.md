...
<div align="center">
  <img src="assets/AUS_network_visualization.svg"
...
|--------|-------|-------------|
| **Total Buses** | 45 | Transmission substations and connection points |
...
|------------------|-------|-------------|
| **Plants Mapped to Buses** | 1260 | GEM power plants assigned to grid locations |
...
|----------------|-------|--------|
| **Grid Cells** | 4884 | 50×50 km renewable energy zones |
| **Solar / Wind Onshore Zones** | 2400 | Grid cells with solar and onshore wind potential |
| **Wind Offshore Zones** | 869 | Grid cells with offshore wind potential |
| **Zone–Bus Mappings** | 3271 | REZoning zones assigned to transmission buses |
...
<div align="center">
  <img src="assets/AUS_demand_bus_verification.png"
       alt="Demand-region to bus mapping verification" style="max-width:100%;">
</div>

### Load Concentration

- **Highest Load Bus:** way/89180086-220 (0.375 share)
- **Load Distribution CV:** 64.4% (coefficient of variation across buses with non-zero demand)
