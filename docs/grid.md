...
<div align="center">
  <img src="assets/ZAF_network_visualization.svg"
...
|------------------|-------|-------------|
| **Plants Mapped to Buses** | 292 | GEM power plants assigned to grid locations |
...
|----------------|-------|--------|
| **Grid Cells** | 1209 | 50×50 km renewable energy zones |
| **Solar / Wind Onshore Zones** | 591 | Grid cells with solar and onshore wind potential |
| **Wind Offshore Zones** | 172 | Grid cells with offshore wind potential |
| **Zone–Bus Mappings** | 765 | REZoning zones assigned to transmission buses |
...
|--------------------------|-----------------|-----------------|-------------|
| **Demand-Region Clustering** | 9 | 1.0 | Population-weighted clusters mapped to nearest buses |

<div align="center">
  <img src="assets/ZAF_demand_bus_verification.png"
       alt="Demand-region to bus mapping verification" style="max-width:100%;">
</div>

### Load Concentration

- **Highest Load Bus:** way/359805008-400 (0.503 share)
- **Load Distribution CV:** 132.9% (coefficient of variation across buses with non-zero demand)
