...
<div align="center">
  <img src="assets/DEU_network_visualization.svg"
...
|------------------|-------|-------------|
| **Plants Mapped to Buses** | 9360 | GEM power plants assigned to grid locations |
...
|----------------|-------|--------|
| **Grid Cells** | 408 | 50×50 km renewable energy zones |
...
<div align="center">
  <img src="assets/DEU_demand_bus_verification.png"
       alt="Demand-region to bus mapping verification" style="max-width:100%;">
</div>

### Load Concentration

- **Highest Load Bus:** way/870598507 (0.129 share)
- **Load Distribution CV:** 54.0% (coefficient of variation across buses with non-zero demand)
