...
- **Individual Plant Coverage**: 90.5% of total capacity from plant-level GEM data
- **Total Capacity Tracked**: 2.4 GW from all sources
- **Plants Above Threshold**: 12 individual plants tracked above 50 MW threshold
- **Total Plants Processed**: 22 plants in database
...
### Files Included
- **Source Data**: `source_data/VerveStacks_EST.xlsx` - Raw data reconciliation between sources
...
- 12 plants tracked individually above threshold
